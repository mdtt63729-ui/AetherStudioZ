package dev.aetherstudioz.jvm.fixtures;

import dev.aetherstudioz.jvm.host.Counter;
import dev.aetherstudioz.jvm.host.Eager;
import dev.aetherstudioz.jvm.host.Shape;
import dev.aetherstudioz.jvm.host.Weighted;
import dev.aetherstudioz.jvm.host.WeightedBase;
import dev.aetherstudioz.jvm.host.Widget;
...
public final class Peers {
    ...
    public static boolean triangleIsSized() {
        return new Triangle() instanceof dev.aetherstudioz.jvm.host.Sized;
    }
    ...
    public static String suppliedTagViaHost() {
        dev.aetherstudioz.jvm.host.Tagged t = dev.aetherstudioz.jvm.host.Factory.make(
            () -> new dev.aetherstudioz.jvm.host.Tagged() {
