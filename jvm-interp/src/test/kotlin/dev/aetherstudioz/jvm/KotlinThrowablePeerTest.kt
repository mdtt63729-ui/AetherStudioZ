...
import dev.aetherstudioz.jvm.kfixtures.rethrownByRealCode
import dev.aetherstudioz.jvm.kfixtures.rethrownByRealCodeCaughtAsThrowable
import dev.aetherstudioz.jvm.kfixtures.rethrownByRealCodeNotAnException
import dev.aetherstudioz.jvm.kfixtures.suspendCoroutineResumeWithException
 ...
 * peer's (`dev.aetherstudioz.jvm.peers.…_Peer3`), not the interpreted one. Matching a `catch` against that name finds
