...
import dev.aetherstudioz.jvm.fixtures.Threading
...
class ThreadingTest {
    ...
    @Test fun volatileFieldsAreBackedByAtomicReference() {
        ...
        assertEquals(0L, vm.interpretedStaticValue("dev.aetherstudioz.jvm.fixtures.Threading\$Holder", "staticVolatileVal"))
    }
