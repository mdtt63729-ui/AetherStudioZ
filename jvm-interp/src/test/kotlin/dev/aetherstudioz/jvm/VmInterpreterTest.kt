...
import dev.aetherstudioz.jvm.fixtures.Arithmetic
import dev.aetherstudioz.jvm.fixtures.Bridged
import dev.aetherstudioz.jvm.fixtures.ClassLit
import dev.aetherstudioz.jvm.fixtures.Constants
import dev.aetherstudioz.jvm.fixtures.Construct
import dev.aetherstudioz.jvm.fixtures.Lambdas
import dev.aetherstudioz.jvm.fixtures.Objects
import dev.aetherstudioz.jvm.fixtures.Recover
import dev.aetherstudioz.jvm.fixtures.ReflectArray
import dev.aetherstudioz.jvm.fixtures.Statics
...
class VmInterpreterTest {
    ...
    private val vm = Vm() // classpath source + default policy (interpret dev.aetherstudioz.*, bridge java.*)
    ...
    @Test fun reflectiveInstantiationOfAnInterpretedClass() {
        ...
        val dog = "dev.aetherstudioz.jvm.fixtures.ReflectInstantiate\$Dog"
    ...
    @Test fun staticFinalConstantsHonorConstantValueAttribute() {
        ...
        val C = "dev.aetherstudioz.jvm.fixtures.Constants"
