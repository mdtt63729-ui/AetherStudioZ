...
// plugin-api's own PLUGIN_SPI_VERSION (in `dev.aetherstudioz.spi-pom`), which is also what the Create-Project template
...
// what lets a plugin linking against them choose its own license. The rest of AetherStudioZ stays plain
