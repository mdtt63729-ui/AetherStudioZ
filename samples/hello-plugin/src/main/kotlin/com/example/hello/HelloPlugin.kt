...
import dev.aetherstudioz.plugin.action.ActionResult
import dev.aetherstudioz.plugin.action.SimpleAction
import dev.aetherstudioz.plugin.action.TextEdit
import dev.aetherstudioz.plugin.action.UI_ACTION_EP

/**
 * The entry point named by `res/raw/aetherstudioz_plugin.toml`. The IDE instantiates this class off the
...
class HelloPlugin : Plugin {
    ...
    // No manifest is declared here: res/raw/aetherstudioz_plugin.toml is this plugin's identity, and the IDE
