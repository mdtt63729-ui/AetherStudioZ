...
/**
 * This app's own screen, and the activity whose intent filter makes the app discoverable as a AetherStudioZ
...
class PluginInfoActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        body.addView(text("A AetherStudioZ plugin shipped as its own app.", size = 15f, color = "#B0B0BC"))
        body.addView(
            text(
                "\nInstall AetherStudioZ, then open Settings › Plugins › Installed. " +
