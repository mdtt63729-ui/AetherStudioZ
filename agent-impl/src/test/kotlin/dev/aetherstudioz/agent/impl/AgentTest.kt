...
import dev.aetherstudioz.agent.ContentPart
import dev.aetherstudioz.agent.DiagnosticInfo
import dev.aetherstudioz.agent.LlmClient
import dev.aetherstudioz.agent.LlmMessage
import dev.aetherstudioz.agent.LlmProvider
import dev.aetherstudioz.agent.LlmRequest
import dev.aetherstudioz.agent.LlmStreamEvent
...
import dev.aetherstudioz.agent.StopReason
...
class AgentTest {
    ...
    fun compactorElidesStaleToolResultsButKeepsRecentAndText() {
        ...
        assertEquals(6, compacted.count { it.role == dev.aetherstudioz.agent.LlmRole.USER })
