 ...
 * [dev.aetherstudioz.agent.LlmStreamEvent]s. Kept behind an interface so tests replay recorded payloads offline
 * with no network.
 */
interface LlmTransport {
     ...
     *  to trust for this call (see [ProviderConfig][dev.aetherstudioz.agent.ProviderConfig]). */
 ...
 *  behind a private/regional CA (see [ProviderConfig][dev.aetherstudioz.agent.ProviderConfig]). */
