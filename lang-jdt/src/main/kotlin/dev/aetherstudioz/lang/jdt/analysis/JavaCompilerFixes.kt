package dev.aetherstudioz.lang.jdt.analysis
...
private fun simpleFix(title: String, file: dev.aetherstudioz.vfs.VirtualFile, edit: DocumentEdit): QuickFix =
    eagerFix(title, file, listOf(edit))

private fun eagerFix(fixTitle: String, file: dev.aetherstudioz.vfs.VirtualFile, edits: List<DocumentEdit>): QuickFix =
    object : QuickFix {
