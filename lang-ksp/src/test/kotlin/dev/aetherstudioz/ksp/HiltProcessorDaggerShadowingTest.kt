package dev.aetherstudioz.ksp

import dev.aetherstudioz.build.SourceGenRequest
import dev.aetherstudioz.platform.ToolUrlClassLoader
 ...
 * the processor bundle ships and was compiled against. [dev.aetherstudioz.platform.ToolClassIsolation] pins `dagger.*` to
