...
package dev.aetherstudioz.platform
...
class NativeTombstoneTest {
    ...
    fun readsSignalFaultingThreadAndBacktrace() {
        ...
        val bytes =
            varint(F_ARCH, 1) + // ARM64
                ...
                str(F_ABORT_MESSAGE, "check failed in /data/app/~~ab==/dev.aetherstudioz.assist-1/base.apk") +
                ...
                len(F_MEMORY_MAPPINGS, varint(1, 0x7000) + str(7, "/data/app/~~ab==/dev.aetherstudioz.assist-1/base.apk")) +
                varint(F_UPTIME, 143)
    ...
    fun reducesPathsToBasenames() {
        val bytes =
            varint(F_TID, 9) +
                str(F_ABORT_MESSAGE, "opened /storage/emulated/0/aetherstudioz/projects/Secret/app/Main.kt") +
                thread(9, "main", frame("", "/data/app/~~q==/dev.aetherstudioz.assist-2/oat/arm64/base.odex"))
