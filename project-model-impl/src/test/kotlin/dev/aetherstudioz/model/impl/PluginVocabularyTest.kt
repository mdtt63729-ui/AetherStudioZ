...
class PluginVocabularyTest {
    ...
    @Test
    fun aPluginsOwnVocabularySurvivesSaveAndReopen() = withTempDir("aetherstudioz-plugin-vocab") { dir ->
    ...
    @Test
    fun builtInSpellingsOnDiskAreUnchanged() = withTempDir("aetherstudioz-vocab-ondisk") { dir ->
        val platform = PlatformCore()
