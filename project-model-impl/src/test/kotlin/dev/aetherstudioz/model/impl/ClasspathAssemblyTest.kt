 ...
 * properties of [dev.aetherstudioz.model.ClasspathSnapshot].
 */
class ClasspathAssemblyTest {

    /** consumer → lib;  lib --api--> apiLib,  lib --implementation--> implLib. */
    private fun build(store: ProjectModelStore, platform: dev.aetherstudioz.platform.impl.PlatformCore) {
