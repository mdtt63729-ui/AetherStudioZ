...
class DamagedWorkspaceLoadTest {
    ...
    @Test
    fun aMissingModuleManifestLeavesTheRestOfTheWorkspaceOpenable() = withTempDir("aetherstudioz-damaged") { dir ->
    ...
    @Test
    fun anUnparsableModuleManifestIsSkippedAndLeftOnDisk() = withTempDir("aetherstudioz-damaged") { dir ->
        twoModuleWorkspace(dir)
    ...
    @Test
    fun aModuleManifestMissingItsModuleTableIsSkippedRatherThanGuessed() = withTempDir("aetherstudioz-damaged") { dir ->
        twoModuleWorkspace(dir)
    ...
    @Test
    fun aWorkspaceMissingItsSchemaVersionStillOpens() = withTempDir("aetherstudioz-damaged") { dir ->
        twoModuleWorkspace(dir)
    ...
    @Test
    fun aSchemaVersionHeldAsAStringStillOpens() = withTempDir("aetherstudioz-damaged") { dir ->
        twoModuleWorkspace(dir)
        val ws = dir.resolve(".platform/workspace.json")
    ...
    @Test
    fun unreadableSdksAndLibrariesCostAReResolveNotTheProject() = withTempDir("aetherstudioz-damaged") { dir ->
        twoModuleWorkspace(dir)
    ...
    @Test
    fun oneUnreadableProjectEntryDoesNotHideTheOthers() = withTempDir("aetherstudioz-damaged") { dir ->
        twoModuleWorkspace(dir)
        val ws = dir.resolve(".platform/workspace.json")
    ...
    @Test
    fun aMissingWorkspaceFileAndANewerSchemaStillFail() = withTempDir("aetherstudioz-damaged") { dir ->
        twoModuleWorkspace(dir)
        val ws = dir.resolve(".platform/workspace.json")
