package dev.aetherstudioz.vfs.local

import dev.aetherstudioz.platform.ContentHash
import dev.aetherstudioz.vfs.FileWatch
import dev.aetherstudioz.vfs.VirtualFile
import dev.aetherstudioz.vfs.VirtualFileSystem
 ...
 * only on the `dev.aetherstudioz.vfs` interfaces, it can be swapped in without touching the model.
 *
