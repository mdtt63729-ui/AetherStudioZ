...
import dev.aetherstudioz.model.FileIconProvider
import dev.aetherstudioz.model.IconTarget

/** Compatibility alias; moved to `project-model-api` (see [dev.aetherstudioz.model.FileIconRegistry]). */
@Deprecated(
    "Moved to project-model-api",
    ReplaceWith("FileIconRegistry", "dev.aetherstudioz.model.FileIconRegistry"),
)
typealias FileIconRegistry = dev.aetherstudioz.model.FileIconRegistry
