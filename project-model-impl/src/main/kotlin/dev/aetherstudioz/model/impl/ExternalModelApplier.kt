...
import dev.aetherstudioz.model.sanitizeLibraryName
...
/**
 * Applies a [ExternalProjectModel] snapshot (what a [dev.aetherstudioz.model.sync.ProjectImporter] read out of a
...
class ExternalModelApplier(private val store: ProjectModelStore) {
     ...
     * build files own the whole model ([dev.aetherstudioz.model.sync.ModelOwnership.EXTERNAL]): unlinking a module from
