...
import dev.aetherstudioz.model.ModifiableModule
...
import dev.aetherstudioz.model.event.DependenciesChanged
import dev.aetherstudioz.model.event.FacetsChanged
import dev.aetherstudioz.model.event.ModuleAdded
import dev.aetherstudioz.model.event.ModuleRemoved
import dev.aetherstudioz.model.event.ModuleSettingsChanged
import dev.aetherstudioz.model.event.ProjectAdded
import dev.aetherstudioz.model.event.ProjectModelEvent
import dev.aetherstudioz.model.event.ProjectRemoved
import dev.aetherstudioz.model.event.ProjectSettingsChanged
import dev.aetherstudioz.model.event.SourceSetsChanged
