...
package dev.aetherstudioz.plugin
 ...
 * vocabularies ([dev.aetherstudioz.model.ContentRole], [dev.aetherstudioz.model.PlatformKind], [dev.aetherstudioz.model.LibraryKind],
 * [dev.aetherstudioz.model.LanguageLevel], [dev.aetherstudioz.model.DependencyScope] and [dev.aetherstudioz.model.ClasspathEntryKind])
 ...
 *
 *  - promoted the model registries a plugin needs to reach ([dev.aetherstudioz.model.FacetCodecRegistry],
 *    [dev.aetherstudioz.model.ModuleTypeRegistry], [dev.aetherstudioz.model.ProjectTemplateRegistry],
 *    [dev.aetherstudioz.model.FileIconRegistry]) out of the unpublished `project-model-impl` into `project-model-api`;
 *  - added `dev.aetherstudioz.lang.CompilationContextProvider`, so a plugin supplies the analysis inputs for its own
 *    language rather than receiving the model's JVM reading of a module, and gave
 *    `dev.aetherstudioz.lang.CompilationContext` defaults for every member a non-JVM language has no answer for
...
data class PluginManifest(
    ...
    /**
     * The class FQCNs implementing the UI facet (`dev.aetherstudioz.plugin.ui.UiPlugin`, from the `plugin-ui-api`
