...
import dev.aetherstudioz.store.StoreAccountService
import dev.aetherstudioz.store.StoreAuthChallenge
...
class SupabaseAccountService(
     ...
     */
    private val enabledProviders: List<dev.aetherstudioz.store.StoreProvider> =
        listOf(dev.aetherstudioz.store.StoreProvider.GITHUB),
    private val connectTimeoutMs: Int = 10_000,
    private val readTimeoutMs: Int = 20_000,
) : StoreAccountService {

    override fun providers(): List<dev.aetherstudioz.store.StoreProvider> =
