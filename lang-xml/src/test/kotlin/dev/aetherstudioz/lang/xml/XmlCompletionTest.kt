...
class XmlCompletionTest {
    ...
    fun matchesAttributeLocalNameWithoutNamespacePrefix() = runTest {
        ...
        val contributor = dev.aetherstudioz.lang.xml.completion.XmlCompletionContributor {
    ...
    fun serviceMergesAndPrefixFiltersContributors() = runTest {
        val contributor = dev.aetherstudioz.lang.xml.completion.XmlCompletionContributor { p ->
