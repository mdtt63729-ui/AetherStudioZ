...
import dev.aetherstudioz.lang.xml.FakeFile
import dev.aetherstudioz.lang.xml.parse
...
class XmlInlayHintServiceTest {
    ...
    fun showsResolvedValueAfterALocalReference() = runTest {
        ...
        val resolver = XmlResourceValueResolver { rClass, name ->
            if (rClass == "string" && name == "app_name") "AetherStudioZ" else null // drawable = file (no value); framework skipped
        }
        ...
        assertEquals("AetherStudioZ", hints[0].parts.single().text)
