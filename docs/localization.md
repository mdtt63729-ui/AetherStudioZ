...
The generated accessor class is `dev.aetherstudioz.ui.generated.resources.Res` (configured in
`ide-ui/build.gradle.kts` under `compose.resources { ... }`, `publicResClass = false` so it stays
an internal `dev.aetherstudioz.ui` detail).
...
`` import dev.aetherstudioz.ui.generated.resources.`continue` `` then `` stringResource(Res.string.`continue`) ``.
