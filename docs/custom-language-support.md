# Adding a language to AetherStudioZ

Every editing feature in AetherStudioZ reaches source code through one of a handful of SPIs, and none of them
...
| Requirement | Why |
| --- | --- |
| The AetherStudioZ repository, buildable locally | A language is a set of Gradle modules in the same build |
...
[`dev.aetherstudioz.lang.LanguageBackend`](../language-api/src/main/kotlin/dev/ide/lang/LanguageBackend.kt)
...
[`dev.aetherstudioz.lang.dom`](../language-api/src/main/kotlin/dev/ide/lang/dom/Dom.kt)
...
[`dev.aetherstudioz.lang.incremental`](../language-api/src/main/kotlin/dev/ide/lang/incremental/Incremental.kt)
...
[`dev.aetherstudioz.lang.resolve`](../language-api/src/main/kotlin/dev/ide/lang/resolve/Resolve.kt) defines four types
...
[`dev.aetherstudioz.lang.completion.CompletionContributor`](../language-api/src/main/kotlin/dev/ide/lang/completion/Contributor.kt)
...
This runs on the shared engine thread and is expected to poll `dev.aetherstudioz.platform.EngineCancellation` so that
...
[`dev.aetherstudioz.index.IndexExtension`](../index-api/src/main/kotlin/dev/ide/index/IndexExtension.kt)
...
[`dev.aetherstudioz.analysis`](../analysis-api/src/main/kotlin/dev/ide/analysis/Analyzers.kt) offers two shapes over a
common base:
...
[`dev.aetherstudioz.lang.synthetic`](../language-api/src/main/kotlin/dev/ide/lang/synthetic/SyntheticClass.kt)
...
| FQN | Id | Type | Adds |
| --- | --- | --- | --- |
| `dev.aetherstudioz.lang.FILE_TYPE_EP` | `platform.fileType` | `FileTypeMapping` | Suffix to language routing |
| `dev.aetherstudioz.lang.LANGUAGE_BACKEND_EP` | `platform.languageBackend` | `LanguageBackend` | Parsing, resolution, editor services |
| `dev.aetherstudioz.lang.COMPILATION_CONTEXT_PROVIDER_EP` | `platform.compilationContext` | `CompilationContextProvider` | Your language's analysis inputs |
...
| `dev.aetherstudioz.lang.postfix.POSTFIX_TEMPLATE_EP` | `platform.postfixTemplate` | `PostfixTemplate` | Postfix templates |
| `dev.aetherstudioz.lang.synthetic.SYNTHETIC_CLASS_EP` | `platform.syntheticClass` | `SyntheticClassProvider` | Types with no file on disk |
| `dev.aetherstudioz.index.INDEX_EP` | `platform.index` | `IndexExtension<*, *>` | A searchable index |
| `dev.aetherstudioz.analysis.ANALYZER_EP` | `platform.analyzer` | `Analyzer` | Inspections |
| `dev.aetherstudioz.analysis.DIAGNOSTIC_PROVIDER_EP` | `platform.diagnosticProvider` | `DiagnosticProvider` | Compiler diagnostics |
| `dev.aetherstudioz.analysis.QUICK_FIX_PROVIDER_EP` | `platform.quickFixProvider` | `QuickFixProvider` | Fixes keyed by code |
| `dev.aetherstudioz.analysis.ACTION_PROVIDER_EP` | `platform.actionProvider` | `ActionProvider` | Intentions keyed by position |
| `dev.aetherstudioz.build.BUILD_PLUGIN_EP` | `platform.buildPlugin` | `BuildPlugin` | Tasks in an existing pipeline |
| `dev.aetherstudioz.build.BUILD_SYSTEM_EP` | `platform.buildSystem` | `BuildSystem` | A whole pipeline |
| `dev.aetherstudioz.build.SOURCE_GENERATOR_EP` | `platform.sourceGenerator` | `SourceGenerator` | Generated sources |
| `dev.aetherstudioz.build.RUN_TASK_PROVIDER_EP` | `platform.runTaskProvider` | `RunTaskProvider` | Run-picker rows |
| `dev.aetherstudioz.model.ModuleTypeExtensionPoint` | `platform.moduleType` | `ModuleType` | A module kind |
| `dev.aetherstudioz.model.template.ProjectTemplateExtensionPoint` | `platform.projectTemplate` | `ProjectTemplate` | A Create-Project entry |
| `dev.aetherstudioz.model.FACET_CODEC_EP` | `platform.facetCodec` | `FacetCodec<*>` | Facet persistence |
| `dev.aetherstudioz.model.sync.PROJECT_IMPORTER_EP` | `platform.projectImporter` | `ProjectImporter` | Reading a foreign project |
| `dev.aetherstudioz.model.sync.BUILD_FILE_WRITER_EP` | `platform.buildFileWriter` | `BuildFileWriter` | Writing build files |
| `dev.aetherstudioz.model.FileIconExtensionPoint` | `platform.fileIcon` | `FileIconProvider` | File-tree icons |
| `dev.aetherstudioz.block.BLOCK_MAPPING_EP` | `platform.blockMapping` | `BlockMapping` | Block-editor projection |
...
| FQN | File |
| --- | --- |
| `dev.aetherstudioz.lang.LanguageBackend` / `SourceAnalyzer` / `CompilationContext` / `CompilationContextProvider` / `ContextKey` / `BackendCapability` / `LanguageId` / `CacheInvalidation` | [LanguageBackend.kt](../language-api/src/main/kotlin/dev/ide/lang/LanguageBackend.kt) |
| `dev.aetherstudioz.lang.ModuleCompilationContext` | [ModuleCompilationContext.kt](../language-api/src/main/kotlin/dev/ide/lang/ModuleCompilationContext.kt) |
| `dev.aetherstudioz.lang.LanguageScoped` / `LanguageExtensionIndex` / `appliesTo` | [LanguageExtension.kt](../language-api/src/main/kotlin/dev/ide/lang/LanguageExtension.kt) |
| `dev.aetherstudioz.lang.FileTypeMapping` | [FileType.kt](../language-api/src/main/kotlin/dev/ide/lang/FileType.kt) |
| `dev.aetherstudioz.lang.dom.DomNode` / `ParsedFile` / `NodeKind` / `TextRange` / `Diagnostic` / `Severity` | [Dom.kt](../language-api/src/main/kotlin/dev/ide/lang/dom/Dom.kt) |
| `dev.aetherstudioz.lang.incremental.IncrementalParser` / `DocumentSnapshot` / `DocumentEdit` | [Incremental.kt](../language-api/src/main/kotlin/dev/ide/lang/incremental/Incremental.kt) |
| `dev.aetherstudioz.lang.resolve.Symbol` / `TypeRef` / `Scope` / `ResolveResult` / `StructureItem` / `QuickDocInfo` | [Resolve.kt](../language-api/src/main/kotlin/dev/ide/lang/resolve/Resolve.kt) |
| `dev.aetherstudioz.lang.completion.CompletionContributor` / `CompletionParams` / `CompletionResultSet` / `CompletionWeigher` | [Contributor.kt](../language-api/src/main/kotlin/dev/ide/lang/completion/Contributor.kt) |
| `dev.aetherstudioz.lang.completion.CompletionItem` / `CaretAction` / `CompletionRelevance` | [Completion.kt](../language-api/src/main/kotlin/dev/ide/lang/completion/Completion.kt) |
| `dev.aetherstudioz.lang.highlight.SemanticHighlightService` / `SemanticToken` / `HighlightKind` | [SemanticHighlight.kt](../language-api/src/main/kotlin/dev/ide/lang/highlight/SemanticHighlight.kt) |
| `dev.aetherstudioz.lang.folding.FoldingService` | [CodeFolding.kt](../language-api/src/main/kotlin/dev/ide/lang/folding/CodeFolding.kt) |
| `dev.aetherstudioz.lang.formatting.FormattingService` / `FormatStyle` | [Formatting.kt](../language-api/src/main/kotlin/dev/ide/lang/formatting/Formatting.kt) |
| `dev.aetherstudioz.lang.imports.ImportOrganizerService` | [ImportOrganizer.kt](../language-api/src/main/kotlin/dev/ide/lang/imports/ImportOrganizer.kt) |
| `dev.aetherstudioz.lang.hints.InlayHintService` | [InlayHint.kt](../language-api/src/main/kotlin/dev/ide/lang/hints/InlayHint.kt) |
| `dev.aetherstudioz.lang.signature.SignatureHelpService` | [SignatureHelp.kt](../language-api/src/main/kotlin/dev/ide/lang/signature/SignatureHelp.kt) |
| `dev.aetherstudioz.lang.postfix.PostfixTemplate` | [Postfix.kt](../language-api/src/main/kotlin/dev/ide/lang/postfix/Postfix.kt) |
| `dev.aetherstudioz.lang.template.SnippetExpansion` | [Snippet.kt](../language-api/src/main/kotlin/dev/ide/lang/template/Snippet.kt) |
| `dev.aetherstudioz.lang.synthetic.SyntheticClass` / `SyntheticClassProvider` | [SyntheticClass.kt](../language-api/src/main/kotlin/dev/ide/lang/synthetic/SyntheticClass.kt) |

### Index, analysis, build, model

| FQN | File |
| --- | --- |
| `dev.aetherstudioz.index.IndexExtension` | [IndexExtension.kt](../index-api/src/main/kotlin/dev/ide/index/IndexExtension.kt) |
| `dev.aetherstudioz.index.IndexService` / `IndexStatus` / `KeyDescriptor` / `Externalizer` | [Index.kt](../index-api/src/main/kotlin/dev/ide/index/Index.kt) |
| `dev.aetherstudioz.index.IndexInput` | [IndexInput.kt](../index-api/src/main/kotlin/dev/ide/index/IndexInput.kt) |
| `dev.aetherstudioz.index.IndexOrigin` / `MatchingMode` / `IndexScope` | [IndexOrigin.kt](../index-api/src/main/kotlin/dev/ide/index/IndexOrigin.kt), [MatchingMode.kt](../index-api/src/main/kotlin/dev/ide/index/MatchingMode.kt), [IndexScope.kt](../index-api/src/main/kotlin/dev/ide/index/IndexScope.kt) |
| Shared index ids and externalizers | [IndexValues.kt](../index-api/src/main/kotlin/dev/ide/index/IndexValues.kt) |
| `dev.aetherstudioz.analysis.FileAnalyzer` / `ProjectAnalyzer` / `AnalysisTarget` / `DiagnosticSink` / `AnalyzerTier` | [Analyzers.kt](../analysis-api/src/main/kotlin/dev/ide/analysis/Analyzers.kt) |
| `dev.aetherstudioz.analysis.QuickFix` / `QuickFixProvider` / `WorkspaceEdit` | [QuickFix.kt](../analysis-api/src/main/kotlin/dev/ide/analysis/QuickFix.kt) |
| `dev.aetherstudioz.build.BuildSystem` / `Task` / `TaskGraph` / `RunTaskProvider` / `RunAction` | [Build.kt](../build-api/src/main/kotlin/dev/ide/build/Build.kt) |
| `dev.aetherstudioz.build.BuildPlugin` / `TaskContainer` / `BuildEnv` / `Lifecycle` | [Plugins.kt](../build-api/src/main/kotlin/dev/ide/build/Plugins.kt) |
| `dev.aetherstudioz.build.SourceGenerator` / `SourceGenRequest` | [SourceGenerator.kt](../build-api/src/main/kotlin/dev/ide/build/SourceGenerator.kt) |
| `dev.aetherstudioz.model.ModuleType` / `Facet` / `FacetKey` | [ProjectModel.kt](../project-model-api/src/main/kotlin/dev/ide/model/ProjectModel.kt) |
| `dev.aetherstudioz.model.template.ProjectTemplate` / `TemplateParameter` / `ProjectScaffold` | [ProjectTemplate.kt](../project-model-api/src/main/kotlin/dev/ide/model/template/ProjectTemplate.kt) |
| `dev.aetherstudioz.model.sync.ProjectImporter` / `BuildFileWriter` | [ProjectSync.kt](../project-model-api/src/main/kotlin/dev/ide/model/sync/ProjectSync.kt) |
| `dev.aetherstudioz.model.FacetCodec` / `FacetCodecRegistry` / `FacetData` | [FacetCodec.kt](../project-model-api/src/main/kotlin/dev/ide/model/FacetCodec.kt) |
| `dev.aetherstudioz.model.ModuleTypeRegistry` / `ProjectTemplateRegistry` / `FileIconRegistry` | [ModuleTypeRegistry.kt](../project-model-api/src/main/kotlin/dev/ide/model/ModuleTypeRegistry.kt) |
| `dev.aetherstudioz.model.ContentRole` / `PlatformKind` / `LibraryKind` / `LanguageLevel` / `DependencyScope` | [ProjectModel.kt](../project-model-api/src/main/kotlin/dev/ide/model/ProjectModel.kt) |

### Editor text layer

| FQN | File |
| --- | --- |
| `dev.aetherstudioz.ui.ext.EditorLanguageProfile` / `SyntaxFamily` / `EditorLanguageRegistry` | [EditorLanguages.kt](../ide-ui-api/src/commonMain/kotlin/dev/ide/ui/ext/EditorLanguages.kt) |
| `dev.aetherstudioz.core.ModuleAnalyzers` | [ModuleAnalyzers.kt](../ide-core/src/main/kotlin/dev/ide/core/ModuleAnalyzers.kt) |
