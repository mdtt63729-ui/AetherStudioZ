# Distributing AetherStudioZ via IzzyOnDroid (F-Droid)

This documents how AetherStudioZ is published to the **IzzyOnDroid** F-Droid repository, why the
...
access for arbitrary downloads and no prebuilt binaries. AetherStudioZ's on-device Android pipeline
...
AetherStudioZ is — and discloses any binary blobs as *Anti-Features* rather than rejecting them.
...
- [x] **Public source** — https://github.com/aetherstudioz/AetherStudioZ (branch `main`).
...
- **App name:** AetherStudioZ
- **Source / repo:** https://github.com/aetherstudioz/AetherStudioZ
- **Releases (APK):** https://github.com/aetherstudioz/AetherStudioZ/releases
