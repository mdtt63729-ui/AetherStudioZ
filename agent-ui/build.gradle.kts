...
kotlin {
    ...
    android {
        namespace = "dev.aetherstudioz.agent.ui"
        compileSdk = 36
        minSdk = 24
        compilerOptions {
            jvmTarget.set(JvmTarget.JVM_17)
...
// non-public and pinned to this module's package so it stays a `dev.aetherstudioz.agent.ui` detail.
compose.resources {
    publicResClass = false
    packageOfResClass = "dev.aetherstudioz.agent.ui.generated.resources"
