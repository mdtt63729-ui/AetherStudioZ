...
import dev.aetherstudioz.index.ClassNameExternalizer
...
import dev.aetherstudioz.index.JavaSourceMemberCodec
import dev.aetherstudioz.index.KeyDescriptor
import dev.aetherstudioz.index.MatchingMode
import dev.aetherstudioz.index.MemberExternalizer
import dev.aetherstudioz.index.MemberValue
import dev.aetherstudioz.index.StringExternalizer
import dev.aetherstudioz.index.StringKeyDescriptor
import dev.aetherstudioz.index.SymbolExternalizer
import dev.aetherstudioz.index.SymbolValue
import dev.aetherstudioz.index.classEntryToFqn
import dev.aetherstudioz.index.normalizedJarKey
import dev.aetherstudioz.index.packagePrefixes
import dev.aetherstudioz.lang.java.index.JavaSourceIndexer.DeclKind
 ...
 * structural PSI parse — the ecj-free replacements for `dev.aetherstudioz.lang.jdt.index`. Same [IndexId]s/versions/
...
// [dev.aetherstudioz.index.ClassNameIndex] etc. (Binary Kotlin still flows through `isClassFile`, read from bytecode.)
