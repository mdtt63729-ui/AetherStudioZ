...
object JavaDiagnosticCodes {
     ...
     *  semantic error. Value is the neutral `dev.aetherstudioz.analysis.Codes.UNRESOLVED_REFERENCE` string so the
     ...
     *  [dev.aetherstudioz.lang.java.resolve.JavaSemanticDiagnostics]). */
