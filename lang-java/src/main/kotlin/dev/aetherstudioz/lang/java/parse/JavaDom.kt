package dev.aetherstudioz.lang.java.parse
 ...
 *
 * Mirrors [dev.aetherstudioz.lang.kotlin.parse.KotlinParsedFile]: "represented" nodes are a curated set of meaningful
...
class JavaParsedFile(
    ...
    override val diagnostics: List<Diagnostic> by lazy {
        collectDiagnostics(javaFile) + dev.aetherstudioz.lang.java.resolve.JavaSemanticDiagnostics.of(javaFile)
    }
