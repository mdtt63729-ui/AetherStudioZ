...
import dev.aetherstudioz.index.prefixAll
...
import dev.aetherstudioz.lang.java.completion.JavaCompletion
import dev.aetherstudioz.lang.java.services.JavaFolder
import dev.aetherstudioz.lang.java.services.JavaInlayHints
import dev.aetherstudioz.lang.java.services.JavaSemanticHighlighter
import dev.aetherstudioz.lang.java.services.JavaSignatureHelp
...
import dev.aetherstudioz.lang.java.parse.JavaDomNode
import dev.aetherstudioz.lang.java.parse.JavaIncrementalParser
import dev.aetherstudioz.lang.java.parse.JavaParsedFile
import dev.aetherstudioz.lang.java.resolve.JavaScope
import dev.aetherstudioz.lang.java.resolve.JavaSymbol
import dev.aetherstudioz.lang.java.resolve.JavaTypeRef
import dev.aetherstudioz.lang.java.resolve.symbolKindOf
...
class JavaSourceAnalyzer(private val env: JavaEnvironment) : SourceAnalyzer, JvmIndexScopeProvider {
    ...
    var syntheticClassProvider: () -> List<dev.aetherstudioz.lang.synthetic.SyntheticClass>
    ...
    fun renameTargetAt(name: String, text: CharSequence, offset: Int): dev.aetherstudioz.lang.java.rename.JavaRenameTarget? =
        IntellijPsiHost.withParseLock { dev.aetherstudioz.lang.java.rename.JavaRename.targetAt(env.parse(name, text), offset) }

    fun renameReferencesIn(
        name: String, text: CharSequence, target: dev.aetherstudioz.lang.java.rename.JavaRenameTarget,
    ): List<dev.aetherstudioz.lang.dom.TextRange> =
        IntellijPsiHost.withParseLock { dev.aetherstudioz.lang.java.rename.JavaRename.referencesIn(env.parse(name, text), target) }

    override val importOrganizer: dev.aetherstudioz.lang.imports.ImportOrganizerService = JavaImportOrganizer(env::parse)
