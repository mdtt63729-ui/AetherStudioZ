package dev.aetherstudioz.lang.java.completion
...
import dev.aetherstudioz.lang.java.JavaImportEdits
import dev.aetherstudioz.lang.java.env.JavaEnvironment
import dev.aetherstudioz.psi.IntellijPsiHost
import dev.aetherstudioz.lang.java.resolve.JavaOverrides
...
class JavaCompletion(
     ...
     * this was the last high-frequency unlocked `buildTree` path. See [dev.aetherstudioz.psi.IntellijPsiHost].
     */
    ...
    private fun overridableMethods(cls: PsiClass): Collection<PsiMethod> {
        val own = cls.methods.mapTo(HashSet()) { dev.aetherstudioz.lang.java.resolve.JavaOverrides.erasedSignature(it) }
        ...
        for (m in cls.allMethods) {
            ...
            val sig = dev.aetherstudioz.lang.java.resolve.JavaOverrides.erasedSignature(m)
