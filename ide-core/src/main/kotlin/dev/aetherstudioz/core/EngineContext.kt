 ...
 *
 * This is the keystone of the [dev.aetherstudioz.ui.backend.IdeBackend] decomposition: as later concern services are
...
internal interface EngineContext {
     ...
     * ([dev.aetherstudioz.model.SdkResolution]): the core-Java platform for a `java-*`/`kotlin-*` module, the Android
