...
/**
 * Completion inside a plugin's packaged manifest, `res/raw/aetherstudioz_plugin.toml`.
 *
 * Everything offered here is read from something real rather than from a hardcoded list of guesses: the keys
 * are the ones [dev.aetherstudioz.core.plugins.PluginManifestToml] actually reads, `dependsOn` completes the plugin ids
...
class PluginManifestCompletion(
    ...
    override val id = "aetherstudioz.pluginManifest"
    ...
    private companion object {
        ...
        val KEYS = linkedMapOf(
            ...
            "minHostVersion" to "oldest AetherStudioZ this plugin runs on",
        )
