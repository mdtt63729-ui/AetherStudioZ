...
import dev.aetherstudioz.lang.LanguageExtensionIndex
import dev.aetherstudioz.lang.LanguageId
import dev.aetherstudioz.lang.appliesTo
import dev.aetherstudioz.lang.completion.BasicCompletionResultSet
...
import dev.aetherstudioz.lang.completion.STANDARD_WEIGHERS
 ...
 * [dev.aetherstudioz.lang.SourceAnalyzer.completionContributions], plus every cross-cutting / plugin contributor from
...
class CompletionEngine(private val extensions: ExtensionRegistry) {
     ...
     * backend exposes ([dev.aetherstudioz.lang.SourceAnalyzer.completionContributions]). They are merged into the same run
    ...
    companion object {
        ...
        // [dev.aetherstudioz.lang.completion.CompletionRelevance]; and [SortPriorityWeigher] (1000) honours the legacy
