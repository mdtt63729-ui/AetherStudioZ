...
import dev.aetherstudioz.index.SymbolSearch
 ...
 * Carved out of [dev.aetherstudioz.core.IdeServices].
 *
 * The [indexService][dev.aetherstudioz.index.IndexService] it queries stays shared infrastructure (completion/analysis/
