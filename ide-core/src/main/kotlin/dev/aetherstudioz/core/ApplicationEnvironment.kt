...
import dev.aetherstudioz.core.plugins.ExternalUiFacets
...
import dev.aetherstudioz.plugin.impl.ExternalPluginLoader
import dev.aetherstudioz.plugin.impl.PluginCatalog
 ...
 *    index, analyzer, template, scoped service, and action is contributed by a built-in [dev.aetherstudioz.plugin.Plugin],
...
class ApplicationEnvironment(
    ...
    /**
     * The Compose UI facets ([dev.aetherstudioz.ui.ext.UiPlugin]) of the ENABLED plugins, in load order: the built-ins
