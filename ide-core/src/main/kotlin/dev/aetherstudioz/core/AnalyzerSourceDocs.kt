...
import dev.aetherstudioz.lang.jdt.SourceMethodResolver
 ...
 * index at all (`java.sourceDoc` only accepts [dev.aetherstudioz.index.IndexOrigin.LIBRARY_SOURCE]), so once a sibling
