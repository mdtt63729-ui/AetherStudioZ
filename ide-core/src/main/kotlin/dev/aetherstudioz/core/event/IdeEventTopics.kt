package dev.aetherstudioz.core.event

import dev.aetherstudioz.analysis.Diagnostic
import dev.aetherstudioz.index.IndexStatus
import dev.aetherstudioz.platform.Topic

/**
 * The IDE's plugin-facing lifecycle events, published on the application [dev.aetherstudioz.platform.MessageBus].
 *
 * These sit alongside the lower-level spines already on the bus ([dev.aetherstudioz.vfs.VfsTopics] file changes,
 * [dev.aetherstudioz.model.event.ProjectModelTopics] model commits, [dev.aetherstudioz.core.settings.SettingsTopics]). Where those
 ...
 *
 * Homed here (mirroring [dev.aetherstudioz.core.settings.SettingsTopics], which also lives in ide-core) because these are
