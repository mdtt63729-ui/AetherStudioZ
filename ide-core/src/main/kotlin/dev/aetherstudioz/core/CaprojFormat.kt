...
/**
 * A shareable AetherStudioZ project package (`.caproj`): a deflate zip carrying a project's
...
object CaprojFormat {
    ...
    const val APP_NAME = "AetherStudioZ"
...
data class CaprojManifest(
    ...
    val author: String,
    /** The tool that produced the package (e.g. `AetherStudioZ`). */
