...
/**
 * Records that a project was adopted from a folder no build system claimed: neither a AetherStudioZ workspace
 * nor anything a [dev.aetherstudioz.model.sync.ProjectImporter] recognized.
 *
