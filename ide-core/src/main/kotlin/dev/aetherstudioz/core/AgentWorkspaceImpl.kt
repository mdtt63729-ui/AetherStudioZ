...
import dev.aetherstudioz.agent.ArtifactHit
import dev.aetherstudioz.agent.DiagnosticInfo
import dev.aetherstudioz.agent.DiagnosticSeverity
import dev.aetherstudioz.agent.FileDiagnostic
import dev.aetherstudioz.agent.Location
import dev.aetherstudioz.agent.ModuleInfo
import dev.aetherstudioz.agent.ProjectOverview
import dev.aetherstudioz.agent.QuickFixInfo
import dev.aetherstudioz.agent.RenameResult
import dev.aetherstudioz.agent.RenameTargetInfo
import dev.aetherstudioz.agent.RunResult
import dev.aetherstudioz.agent.SymbolHit
import dev.aetherstudioz.agent.TaskInfo
import dev.aetherstudioz.agent.TaskRunResult
...
import dev.aetherstudioz.lang.kotlin.NavKind
...
internal class IdeAgentWorkspace(private val ctx: BackendContext) : AgentWorkspace {
    ...
    private fun doHttp(
        ...
        val conn = (u.openConnection() as HttpURLConnection).apply {
            ...
            setRequestProperty("User-Agent", "AetherStudioZ-Agent")
            headers.forEach { h ->
                val idx = h.indexOf(':')
