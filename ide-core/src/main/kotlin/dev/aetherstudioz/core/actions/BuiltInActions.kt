...
import dev.aetherstudioz.core.ApplicationEnvironment
...
/**
 * The host's built-in [dev.aetherstudioz.plugin.action.IdeAction]s — pure engine commands surfaced through the action
