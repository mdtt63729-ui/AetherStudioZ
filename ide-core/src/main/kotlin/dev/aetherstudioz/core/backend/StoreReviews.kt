...
import dev.aetherstudioz.store.RemoteReview
import dev.aetherstudioz.store.ReviewSort
import dev.aetherstudioz.store.StoreResult
import dev.aetherstudioz.store.StoreReviewService
import dev.aetherstudioz.ui.backend.UiReviewPage
import dev.aetherstudioz.ui.backend.UiReportReason
import dev.aetherstudioz.ui.backend.UiReviewSort
import dev.aetherstudioz.ui.backend.UiStoreReview
...
internal class StoreReviews(private val reviews: StoreReviewService) {
    ...
    private fun UiReportReason.toWire(): dev.aetherstudioz.store.ReportReason = when (this) {
        UiReportReason.MALWARE -> dev.aetherstudioz.store.ReportReason.MALWARE
        UiReportReason.SPAM -> dev.aetherstudioz.store.ReportReason.SPAM
        UiReportReason.COPYRIGHT -> dev.aetherstudioz.store.ReportReason.COPYRIGHT
        UiReportReason.INAPPROPRIATE -> dev.aetherstudioz.store.ReportReason.INAPPROPRIATE
        UiReportReason.BROKEN -> dev.aetherstudioz.store.ReportReason.BROKEN
        UiReportReason.OTHER -> dev.aetherstudioz.store.ReportReason.OTHER
    }
