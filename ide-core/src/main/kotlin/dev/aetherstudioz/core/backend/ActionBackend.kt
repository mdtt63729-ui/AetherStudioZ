...
import dev.aetherstudioz.plugin.action.CaretAncestor
import dev.aetherstudioz.plugin.action.CaretContext
import dev.aetherstudioz.plugin.action.TextEdit
import dev.aetherstudioz.plugin.impl.ResolvedMenuItem
...
import dev.aetherstudioz.ui.backend.UiActionResult
...
/** [ActionService] over the engine's [dev.aetherstudioz.plugin.impl.ActionManager]: resolve/invoke the contributed
 ...
 * palette) and the editor backend (the [dev.aetherstudioz.plugin.action.ActionPlaces.EDITOR] place), so an action
