...
import dev.aetherstudioz.ui.backend.UiLearnCatalog
import dev.aetherstudioz.ui.backend.UiLearnProgress
import dev.aetherstudioz.ui.backend.UiLearnTrack
import dev.aetherstudioz.ui.backend.UiLesson
import dev.aetherstudioz.ui.backend.UiLessonStep
import dev.aetherstudioz.ui.backend.UiLessonSummary
import dev.aetherstudioz.ui.backend.UiDiagnostic
import dev.aetherstudioz.ui.backend.UiResumePoint
 ...
 * progress through the [ProjectManager][dev.aetherstudioz.core.ProjectManager] preferences, and auto-checks interactive
...
internal class LearnBackend(private val ctx: BackendContext) : LearnService {
    ...
    private val log = dev.aetherstudioz.platform.log.Log.logger("learn.compose")
    ...
    private suspend fun scratchFor(language: String): IdeServices? {
        ...
        return when (language) {
            ...
            "kotlin-compose" -> manager.scratch(
                ...
                mapOf("packageName" to "dev.aetherstudioz.learn.compose", "language" to "kotlin", "minSdk" to "26"),
    ...
    private companion object {
         ...
         *  ([dev.aetherstudioz.android.support.AndroidFeatureDependencies.COMPOSE]); rendering dispatches against the
