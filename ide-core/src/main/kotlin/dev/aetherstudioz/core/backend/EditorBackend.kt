...
import dev.aetherstudioz.analysis.CodeActionKind
import dev.aetherstudioz.analysis.DiagnosticTag
import dev.aetherstudioz.analytics.Events
import dev.aetherstudioz.core.BackendContext
import dev.aetherstudioz.core.event.EditorEvent
...
import dev.aetherstudioz.lang.formatting.FormatStyle
import dev.aetherstudioz.lang.completion.CompletionItemKind
import dev.aetherstudioz.lang.dom.Severity
import dev.aetherstudioz.lang.highlight.HighlightModifier
import dev.aetherstudioz.lang.hints.InlayHintKind
import dev.aetherstudioz.platform.EngineCanceledException
import dev.aetherstudioz.ui.backend.AnalysisPreempted
...
import dev.aetherstudioz.ui.backend.UiCaretAncestor
import dev.aetherstudioz.ui.backend.UiCaretContext
import dev.aetherstudioz.ui.backend.UiActionKind
import dev.aetherstudioz.ui.backend.UiCaret
import dev.aetherstudioz.ui.backend.UiCompletionItem
import dev.aetherstudioz.ui.backend.UiCompletionKind
import dev.aetherstudioz.ui.backend.UiCompletionResult
import dev.aetherstudioz.ui.backend.UiDefinition
import dev.aetherstudioz.ui.backend.UiLibraryContent
...
import dev.aetherstudioz.ui.backend.UiFileSymbol
import dev.aetherstudioz.ui.backend.UiInheritorMarker
import dev.aetherstudioz.ui.backend.UiInheritorTarget
import dev.aetherstudioz.ui.backend.UiQuickDoc
import dev.aetherstudioz.ui.backend.UiDiagnostic
import dev.aetherstudioz.ui.backend.UiFoldRegion
import dev.aetherstudioz.ui.backend.UiHighlightModifier
import dev.aetherstudioz.ui.backend.UiInlayHint
import dev.aetherstudioz.ui.backend.UiInlayKind
import dev.aetherstudioz.ui.backend.UiInlayPart
import dev.aetherstudioz.ui.backend.UiRenameResult
import dev.aetherstudioz.ui.backend.UiRenameTarget
import dev.aetherstudioz.ui.backend.UiSemanticToken
import dev.aetherstudioz.ui.backend.UiSeverity
import dev.aetherstudioz.ui.backend.UiSignature
import dev.aetherstudioz.ui.backend.UiSignatureHelp
import dev.aetherstudioz.ui.backend.UiSignatureParam
import dev.aetherstudioz.ui.backend.UiSnippet
import dev.aetherstudioz.ui.backend.UiSnippetStop
import dev.aetherstudioz.ui.backend.UiTextEdit
import dev.aetherstudioz.ui.backend.UiTextRange
...
internal class EditorBackend(private val ctx: BackendContext) : EditorService {
    ...
    private fun toNavKind(kind: UiNavKind): dev.aetherstudioz.lang.kotlin.NavKind = when (kind) {
        UiNavKind.DECLARATION -> dev.aetherstudioz.lang.kotlin.NavKind.DECLARATION
        UiNavKind.IMPLEMENTATION -> dev.aetherstudioz.lang.kotlin.NavKind.IMPLEMENTATION
        UiNavKind.TYPE_DECLARATION -> dev.aetherstudioz.lang.kotlin.NavKind.TYPE_DECLARATION
        UiNavKind.SUPER -> dev.aetherstudioz.lang.kotlin.NavKind.SUPER
    }

    private fun fromNavKind(kind: dev.aetherstudioz.lang.kotlin.NavKind): UiNavKind = when (kind) {
        dev.aetherstudioz.lang.kotlin.NavKind.DECLARATION -> UiNavKind.DECLARATION
        dev.aetherstudioz.lang.kotlin.NavKind.IMPLEMENTATION -> UiNavKind.IMPLEMENTATION
        dev.aetherstudioz.lang.kotlin.NavKind.TYPE_DECLARATION -> UiNavKind.TYPE_DECLARATION
        dev.aetherstudioz.lang.kotlin.NavKind.SUPER -> UiNavKind.SUPER
    }
