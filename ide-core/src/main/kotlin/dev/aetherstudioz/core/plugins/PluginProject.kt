...
/**
 * What makes a module a AetherStudioZ plugin, as far as the IDE is concerned: it packages a
 * `res/raw/aetherstudioz_plugin.toml`. That file is the same thing the package manager hands another install of
...
object PluginProject {
    ...
    /** True when [module] builds a AetherStudioZ plugin. */
    ...
    const val MANIFEST_NAME = "aetherstudioz_plugin.toml"
