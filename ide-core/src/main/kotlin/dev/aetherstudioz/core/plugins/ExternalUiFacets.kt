...
import dev.aetherstudioz.plugin.impl.EntryPointInstances
import dev.aetherstudioz.plugin.impl.PluginLoadFailure
import dev.aetherstudioz.ui.ext.UiContributionScope
import dev.aetherstudioz.ui.ext.UiPlugin
import dev.aetherstudioz.ui.ext.asUiPlugin
 ...
 * already loaded.
 *
 * The loader in `plugin-impl` cannot do this itself: `dev.aetherstudioz.plugin.ui.UiPlugin` is a Compose-bearing type
