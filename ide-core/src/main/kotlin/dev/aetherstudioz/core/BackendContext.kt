...
internal interface BackendContext {
    ...
    val sdkManager: dev.aetherstudioz.core.SdkManagerService?
    ...
    val keystoreRegistry: dev.aetherstudioz.android.support.tools.KeystoreRegistry?
     ...
     *  fine-grained crash-breadcrumb label (see [dev.aetherstudioz.platform.EngineBreadcrumb]); default → the lane name. */
     ...
     *  host with neither a manager nor an open project. See [dev.aetherstudioz.core.event.IdeEventTopics]. */
    val messageBus: dev.aetherstudioz.platform.MessageBus?
