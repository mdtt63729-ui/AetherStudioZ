 ...
 * `dev.aetherstudioz.lang.kotlin.parse.KotlinParserHost` and the XML backend register their language onto it (see
...
object IntellijPsiHost {
    ...
    private val environment: KotlinCoreEnvironment by lazy {
        ...
        // environment creation. Mirrors dev.aetherstudioz.lang.kotlin.compile.KotlinEnvironmentKeepAlive (which the build
