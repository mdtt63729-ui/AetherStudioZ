 ...
 * [dev.aetherstudioz.ui.platform.dynamicColorSchemeOrNull]). One neutral surface ramp is shared across the three
...
// ---- Aurora Indigo: a COMPLETE scheme with its own cool neutrals ----
//
// A deeper, more sophisticated palette: indigo primary, teal secondary, rose tertiary over a cool
// near-black surface ramp. The dark mode reads as a premium "night sky" feel; light mode is a soft
// off-white with vivid but never harsh accents.

private val IndigoDark = darkColorScheme(
    primary = Color(0xFFAEC6FF), onPrimary = Color(0xFF002E69),
    primaryContainer = Color(0xFF1E4595), onPrimaryContainer = Color(0xFFD8E2FF),
    inversePrimary = Color(0xFF3A5B9F),
    ...
    tertiary = Color(0xFFE4BAD9), onTertiary = Color(0xFF43263F),
    tertiaryContainer = Color(0xFF5B3C56), onTertiaryContainer = Color(0xFFFFD7F2),
    background = Color(0xFF131317), onBackground = Color(0xFFE4E1E9),
    surface = Color(0xFF131317), onSurface = Color(0xFFE4E1E9),
    surfaceVariant = Color(0xFF45464F), onSurfaceVariant = Color(0xFFC6C5D0),
    surfaceTint = Color(0xFFAEC6FF),
    inverseSurface = Color(0xFFE4E1E9), inverseOnSurface = Color(0xFF303036),
    outline = Color(0xFF90909A), outlineVariant = Color(0xFF45464F),
    scrim = Color(0xFF000000),
    surfaceBright = Color(0xFF39383F), surfaceDim = Color(0xFF131317),
...
private val IndigoLight = lightColorScheme(
    primary = Color(0xFF3A5B9F), onPrimary = Color(0xFFFFFFFF),
    ...
    secondaryContainer = Color(0xFFDFE1F9), onSecondaryContainer = Color(0xFF171A2C),
    tertiary = Color(0xFF75546F), onTertiary = Color(0xFFFFFFFF),
    tertiaryContainer = Color(0xFFFFD7F2), onTertiaryContainer = Color(0xFF2C1229),
    background = Color(0xFFFBF8FF), onBackground = Color(0xFF1B1B21),
    surface = Color(0xFFFBF8FF), onSurface = Color(0xFF1B1B21),
    surfaceVariant = Color(0xFFE3E1E9), onSurfaceVariant = Color(0xFF45464F),
    surfaceTint = Color(0xFF3A5B9F),
    inverseSurface = Color(0xFF303036), inverseOnSurface = Color(0xFFF2F0F7),
    outline = Color(0xFF767680), outlineVariant = Color(0xFFC6C5D0),
    scrim = Color(0xFF000000),
    surfaceBright = Color(0xFFFBF8FF), surfaceDim = Color(0xFFDBD9E0),
    surfaceContainerLowest = Color(0xFFFFFFFF),
...
fun expressiveColorScheme(accent: CaAccent, dark: Boolean): ColorScheme {
    // Lime and Indigo carry their own neutrals and return early; the rest share one ramp.
    if (accent == CaAccent.Lime) return if (dark) LimeDark else LimeLight
    if (accent == CaAccent.Indigo) return if (dark) IndigoDark else IndigoLight
    val roles = when (accent) {
        ...
        CaAccent.Lime, CaAccent.Indigo -> error("handled above")
    }
