...
/**
 * What the export writes. A `.caproj` is the lossless form another AetherStudioZ reads back; a Gradle project
 * is the way out to Android Studio or a `gradle` build, generated from the project model and therefore best
 * effort (see [dev.aetherstudioz.ui.backend.UiGradleExport]).
 */
