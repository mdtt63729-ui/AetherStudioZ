...
import dev.aetherstudioz.ui.generated.resources.*
import org.jetbrains.compose.resources.StringResource
import org.jetbrains.compose.resources.stringResource

/**
 * A localization overlay for the built-in Settings pages. Their titles/descriptions/option labels are declared
 * in `ide-core` ([dev.aetherstudioz.core.settings.BuiltInSettingsPages] + `SettingsBackend`) as plain English — `ide-core`
 ...
 *
 * Keys mirror the [dev.aetherstudioz.core.settings.BuiltInSettingsPages] constants; option keys append the option value.
 */
...
private val OPTION_LABEL: Map<String, StringResource> = mapOf(
    ...
    "appearance.accent.indigo" to Res.string.set_appearance_accent_indigo,
