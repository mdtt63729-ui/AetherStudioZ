...
import dev.aetherstudioz.ui.backend.UiChartEntry
import dev.aetherstudioz.ui.backend.UiFeedSection
import dev.aetherstudioz.ui.backend.UiShelfLayout
import dev.aetherstudioz.ui.backend.UiStoreCollection
import dev.aetherstudioz.ui.backend.UiStoreFeed
import dev.aetherstudioz.ui.backend.UiStoreItem
import dev.aetherstudioz.ui.backend.UiStoreMode
import dev.aetherstudioz.ui.backend.UiStorePublisher
import dev.aetherstudioz.ui.generated.resources.store_bundled_subtitle
import dev.aetherstudioz.ui.generated.resources.store_bundled_title
import dev.aetherstudioz.ui.generated.resources.store_catalogue_subtitle
import dev.aetherstudioz.ui.generated.resources.store_collections_title
import dev.aetherstudioz.ui.generated.resources.store_ghost_next_title
import dev.aetherstudioz.ui.generated.resources.store_ghost_section_subtitle
import dev.aetherstudioz.ui.generated.resources.store_ghost_section_title
import dev.aetherstudioz.ui.generated.resources.store_ghostspec_charts_note
import dev.aetherstudioz.ui.generated.resources.store_ghostspec_collections_note
import dev.aetherstudioz.ui.generated.resources.store_ghostspec_rec_note
import dev.aetherstudioz.ui.generated.resources.store_ghostspec_rec_title
import dev.aetherstudioz.ui.generated.resources.store_how_publishing_title
import dev.aetherstudioz.ui.generated.resources.store_meta_offline
import dev.aetherstudioz.ui.generated.resources.store_top_charts
import dev.aetherstudioz.ui.generated.resources.store_signin_title
import dev.aetherstudioz.ui.components.SquareToneButton
import dev.aetherstudioz.ui.components.inFlight
import dev.aetherstudioz.ui.components.installActionLabel
import dev.aetherstudioz.ui.components.AdSlot
import dev.aetherstudioz.ui.components.BundledTemplateRow
import dev.aetherstudioz.ui.components.ChartCard
import dev.aetherstudioz.ui.components.ChartTabRow
import dev.aetherstudioz.ui.components.CollectionCard
import dev.aetherstudioz.ui.components.EmptyStoreHero
import dev.aetherstudioz.ui.components.NotifySwitchRow
import dev.aetherstudioz.ui.components.PublishingSteps
import dev.aetherstudioz.ui.components.SubmissionStatusCard
import dev.aetherstudioz.ui.components.defaultPublishSteps
import dev.aetherstudioz.ui.components.emptyGhostNote
import dev.aetherstudioz.ui.components.Eyebrow
import dev.aetherstudioz.ui.components.FeaturedHeroCard
import dev.aetherstudioz.ui.components.GhostShelfCard
import dev.aetherstudioz.ui.components.LiveDot
import dev.aetherstudioz.ui.components.PosterCard
import dev.aetherstudioz.ui.components.PublishPitchBand
import dev.aetherstudioz.ui.components.SparseProjectCard
import dev.aetherstudioz.ui.components.SpotlightCard
import dev.aetherstudioz.ui.components.StoreCountBadge
import dev.aetherstudioz.ui.components.TrendingTicker
import dev.aetherstudioz.ui.components.chartMeta
...
import dev.aetherstudioz.ui.generated.resources.store_title
import org.jetbrains.compose.resources.stringResource
...
fun ExploreFeed(
     ...
     */
    installing: Map<String, dev.aetherstudioz.ui.backend.UiInstallProgress> = emptyMap(),
    /** The signed-in account's in-flight submission, shown above the hero. Null hides the card. */
    submission: dev.aetherstudioz.ui.backend.UiStoreSubmission? = null,
...
private fun LazyListScope.shelfSection(
    ...
    onOpenItem: (UiStoreItem) -> Unit,
    onInstallItem: (UiStoreItem) -> Unit,
    installing: Map<String, dev.aetherstudioz.ui.backend.UiInstallProgress>,
) {
    ...
    itemsIndexed(rows, key = { i, _ -> "catrow_${section.id}_$i" }) { rowIndex, row ->
        ...
        Row(
            ...
            row.forEachIndexed { colIndex, cat ->
                ...
                dev.aetherstudioz.ui.components.CategoryTile(
                    name = cat,
                    count = section.counts[cat] ?: 0,
                    glyph = CaSymbols.forIconId(cat.lowercase()),
                    pair = tonalPair(i),
                    shape = dev.aetherstudioz.ui.theme.cardShape(i),
...
private fun ExploreEmpty(
    ...
    onPublish: () -> Unit,
    onGuide: () -> Unit,
    submission: dev.aetherstudioz.ui.backend.UiStoreSubmission?,
    onWithdrawSubmission: () -> Unit,
    onViewSubmissionNotes: () -> Unit,
    onViewListing: () -> Unit,
