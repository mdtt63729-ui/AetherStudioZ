 ...
 * ([dev.aetherstudioz.ui.ext.BuiltInUiPlugin]) as plain English — the plugin API carries plain strings (third-party
 ...
 * through).
 *
 * Keys mirror the [dev.aetherstudioz.ui.ext.SimpleUiAction] ids.
 */
