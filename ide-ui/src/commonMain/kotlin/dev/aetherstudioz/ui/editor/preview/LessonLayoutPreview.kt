...
/**
 * A compact, live Android layout preview embedded in a Learn lesson (a [dev.aetherstudioz.ui.backend.UiContentBlock.LayoutPreview]).
 ...
 * commonMain can't depend on) and casts [backend] to [dev.aetherstudioz.preview.LayoutPreviewBackend]. A host without
