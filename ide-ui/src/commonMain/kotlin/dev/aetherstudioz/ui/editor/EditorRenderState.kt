...
import dev.aetherstudioz.ui.editor.core.EditorDocument
import dev.aetherstudioz.ui.editor.core.EditorSession
import dev.aetherstudioz.ui.editor.core.InlayPiece
import dev.aetherstudioz.ui.editor.core.LineRenderCache
import dev.aetherstudioz.ui.theme.CaTypography
import dev.aetherstudioz.ui.theme.AetherStudioZColors
...
internal class EditorRenderState(private val session: EditorSession) {
     ...
     * that cost per frame. A line's indent is a pure function of its text, and [dev.aetherstudioz.ui.editor.core.LineStyles]
     ...
     *  Cached by the line's [dev.aetherstudioz.ui.editor.core.LineStyles] revision so a fling reads it without rope walks. */
