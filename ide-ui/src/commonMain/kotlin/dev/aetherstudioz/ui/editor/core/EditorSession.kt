package dev.aetherstudioz.ui.editor.core
...
import dev.aetherstudioz.ui.editor.folding.FoldModel
import dev.aetherstudioz.ui.editor.folding.FoldRegion
import dev.aetherstudioz.ui.editor.shiftComposePreviews
import dev.aetherstudioz.ui.editor.shiftDiagnostics
import dev.aetherstudioz.ui.editor.shiftFoldRegions
import dev.aetherstudioz.ui.editor.shiftInlayHints
import dev.aetherstudioz.ui.editor.shiftSemanticTokens
...
class EditorSession(
     ...
     * ([dev.aetherstudioz.ui.editor.shiftInlayHints]) so the phantom text tracks its anchor between debounced daemon
     ...
     * ([dev.aetherstudioz.ui.editor.shiftFoldRegions]) so a collapsed fold keeps covering its block while typing; the
