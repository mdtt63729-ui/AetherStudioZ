package dev.aetherstudioz.ui.ext
...
import dev.aetherstudioz.plugin.ui.Overlay
import dev.aetherstudioz.plugin.ui.Screen
import dev.aetherstudioz.plugin.ui.ToolWindow
import dev.aetherstudioz.plugin.ui.UiContext
import dev.aetherstudioz.plugin.ui.UiHandle
...
import dev.aetherstudioz.plugin.ui.UiPlugin as ExternalUiPlugin
...
class ExternalUiPluginTest {
        ...
        val facet = facet { ui ->
            ui.toolWindow(
                ToolWindow(
                    ...
                    title = "Panel",
                    iconId = "sparkle",
                    anchor = dev.aetherstudioz.plugin.ui.ToolWindowAnchor.BOTTOM,
                    order = 5,
                ) { },
            )
        }
    ...
    fun disposingTheHandleRemovesTheContribution() {
        ...
        val facet = facet { ui ->
            handle = ui.toolWindow(ToolWindow("id", "Title", "sparkle", dev.aetherstudioz.plugin.ui.ToolWindowAnchor.LEFT) { })
        }
        val scope = RecordingScope("com.example.x")
    ...
    fun theBodySeesTheHostsStateThroughTheNarrowContext() {
        ...
        val facet = facet { ui ->
            ui.toolWindow(ToolWindow("id", "Title", "sparkle", dev.aetherstudioz.plugin.ui.ToolWindowAnchor.LEFT) { ctx ->
                seen = ctx
            })
        }
        val scope = RecordingScope("com.example.x")
