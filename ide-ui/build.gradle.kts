...
kotlin {
    ...
    android {
        namespace = "dev.aetherstudioz.ui"
        compileSdk = 36
        minSdk = 24
        compilerOptions {
            jvmTarget.set(JvmTarget.JVM_17)
...
// Pinned package + non-public so it stays an internal `dev.aetherstudioz.ui` detail the theme reads.
compose.resources {
    publicResClass = false
    packageOfResClass = "dev.aetherstudioz.ui.generated.resources"
