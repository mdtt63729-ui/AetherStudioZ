...
class ValueClassAndObjectRefTest {
    ...
    fun bareObjectReferenceMaterializesTheSingleton() {
        val node = RNode.Name(Binding.ObjectRef("dev.aetherstudioz.interp.Vault", "Vault"), span)
    ...
    fun valueClassPropertyGetterIsFoundDespiteMangling() {
        ...
        val recv = RNode.Name(Binding.ObjectRef("dev.aetherstudioz.interp.Vault", "Vault"), span)
    ...
    fun valueClassParamCallIsFoundDespiteMangling() {
        ...
        val callee = ResolvedCallable.Library(
            displayName = "spend", ownerFqn = "dev.aetherstudioz.interp.ValueClassAndObjectRefTestKt", methodName = "spend",
    ...
    private fun arg(value: Any?) = dev.aetherstudioz.lang.kotlin.interp.RArg(RNode.Const(value, null, span))
    ...
    fun extensionDefaultParamMaskExcludesTheReceiver() {
        ...
        val callee = ResolvedCallable.Library(
            displayName = "scaled", ownerFqn = "dev.aetherstudioz.interp.ValueClassAndObjectRefTestKt", methodName = "scaled",
    ...
    private val facade = "dev.aetherstudioz.interp.ValueClassAndObjectRefTestKt"

    private fun lib(name: String) = ResolvedCallable.Library(
        displayName = name, ownerFqn = "dev.aetherstudioz.interp.ValueClassAndObjectRefTestKt", methodName = name,
        paramTypes = emptyList(), isStatic = true, isConstructor = false, isInline = false, descriptorPrecise = true,
    )
}
