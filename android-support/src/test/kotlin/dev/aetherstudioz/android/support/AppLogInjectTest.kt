...
class AppLogInjectTest {
    ...
    private fun buildVariant(buildSystem: AndroidBuildSystem, project: dev.aetherstudioz.model.Project, variant: String, cache: BuildCache) {
    ...
    private companion object {
        ...
        const val PROVIDER = "dev.aetherstudioz.applog.IdeLogBridgeProvider"
