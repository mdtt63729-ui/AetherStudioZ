...
data class AndroidAppLogRuntime(
    ...
    companion object {
        const val DEFAULT_PROVIDER_CLASS = "dev.aetherstudioz.applog.IdeLogBridgeProvider"
        const val DEFAULT_AUTHORITY_SUFFIX = "dev.aetherstudioz.applog"
        const val DEFAULT_SINK_ACTION = "dev.aetherstudioz.applog.SINK"
    }
}
