package dev.aetherstudioz.android.support.viewbinding
 ...
 * the editor (the synthetic [dev.aetherstudioz.lang.synthetic.SyntheticClass] for completion) and the build (the
