...
import dev.aetherstudioz.android.support.resources.RIdAssignment
import dev.aetherstudioz.android.support.resources.ResourceItem
 ...
 * module's merged [dev.aetherstudioz.android.support.resources.ResourceRepository] (its own `res/` plus its android-lib
...
class AndroidRClassProvider(
    ...
    private fun styleableClass(namespace: String, repo: dev.aetherstudioz.android.support.resources.ResourceRepository, ids: RIdAssignment): SyntheticClass {
