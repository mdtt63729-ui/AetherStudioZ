...
import dev.aetherstudioz.android.support.resources.LenientValuesScan
 ...
 *
 * The project's OWN `res/` roots are fed via [dev.aetherstudioz.index.IndexScope.resourceRoots] (the in-memory source
 * side, edit-sensitive); immutable dependency/AAR `res/` is content-addressed onto disk segments via
 * [dev.aetherstudioz.index.IndexScope.libraryResourceRoots] - so the bulk of a Material/AndroidX resource set is parsed
