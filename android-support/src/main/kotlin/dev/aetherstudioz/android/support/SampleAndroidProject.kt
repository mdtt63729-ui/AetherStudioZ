...
object SampleAndroidProject {
    ...
    fun generate(
        ...
        write(store, "app/src/main/res/values/themes.xml", dev.aetherstudioz.android.support.templates.AndroidAppAssets.themesXml)
        write(store, "app/src/main/res/values-night/themes.xml", dev.aetherstudioz.android.support.templates.AndroidAppAssets.themesNightXml)
        write(store, "app/src/main/res/values/attrs.xml", APP_ATTRS)
        write(store, "app/src/main/res/layout/activity_main.xml", APP_LAYOUT)
        for ((rel, content) in dev.aetherstudioz.android.support.templates.AndroidAppAssets.launcherIconResFiles) {
