...
kotlin {
    ...
    android {
        namespace = "dev.aetherstudioz.vcs.ui"
        compileSdk = 36
        minSdk = 24
        compilerOptions {
            jvmTarget.set(JvmTarget.JVM_17)
...
// module's package so it stays a `dev.aetherstudioz.vcs.ui` detail.
compose.resources {
    publicResClass = false
    packageOfResClass = "dev.aetherstudioz.vcs.ui.generated.resources"
