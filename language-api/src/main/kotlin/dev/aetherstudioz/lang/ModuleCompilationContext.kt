...
object ModuleCompilationContext {
     ...
     * drops any dependency whose [dev.aetherstudioz.model.OrderEntry.variant] qualifier isn't in it (a shared,
...
private class CompilationContextView(
    ...
    override val languageLevel: dev.aetherstudioz.model.LanguageLevel,
