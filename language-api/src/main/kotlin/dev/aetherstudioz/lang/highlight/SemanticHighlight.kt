package dev.aetherstudioz.lang.highlight
 ...
 * [dev.aetherstudioz.lang.BackendCapability.SEMANTIC_HIGHLIGHT] and returning a [SemanticHighlightService] from its
 * analyzer (see [dev.aetherstudioz.lang.SourceAnalyzer.semanticHighlighter]). Adding a language's semantic colors is a
...
interface SemanticHighlightService {
     ...
     * [dev.aetherstudioz.platform.EngineCancellation] so a higher-priority call (completion) can preempt the pass.
