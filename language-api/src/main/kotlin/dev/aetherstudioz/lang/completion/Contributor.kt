package dev.aetherstudioz.lang.completion
...
import dev.aetherstudioz.lang.patterns.ElementPattern
...
/**
 * IntelliJ-style **completion contribution** SPI. The engine ([dev.aetherstudioz.core] `CompletionEngine`) has no
 ...
 * contributors via [dev.aetherstudioz.lang.SourceAnalyzer.completionContributions], alongside cross-cutting ones —
...
class CompletionContribution(
    ...
    val order: Int = 0,
) : dev.aetherstudioz.lang.LanguageScoped
