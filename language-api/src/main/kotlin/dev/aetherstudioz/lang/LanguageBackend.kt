package dev.aetherstudioz.lang
...
enum class BackendCapability {
    ...
    POSTFIX,            // contributes/handles postfix templates (dev.aetherstudioz.lang.postfix)
...
interface CompilationContext {
     ...
     * toolchain needs as an [attribute], or as entries under a [dev.aetherstudioz.model.ClasspathEntryKind] of its own.
     */
...
/**
 * Typed key for a [CompilationContext.attribute]. Like [dev.aetherstudioz.model.FacetKey] it has **reference
...
interface CompilationContextProvider : LanguageScoped {
     ...
     * active build-variant config-name set, as passed to [dev.aetherstudioz.model.Module.classpath]. Must not mutate
...
interface SourceAnalyzer {
     ...
     * or scope-driven keyword logic) as first-class engine contributors. See `dev.aetherstudioz.lang.completion`.
     */
...
enum class CacheInvalidation {
     ...
     * [dev.aetherstudioz.lang.synthetic.SyntheticClassProvider]'s answer changes: an Android resource edit regenerating
