 ...
 * ([dev.aetherstudioz.lang.completion.CompletionContribution], [dev.aetherstudioz.lang.postfix.PostfixTemplate], the analysis
 * providers): an extension that names no language is cross-cutting and runs everywhere. Note this is the
 * opposite of [dev.aetherstudioz.analysis.Analyzer], which must name its languages to run at all.
 */
