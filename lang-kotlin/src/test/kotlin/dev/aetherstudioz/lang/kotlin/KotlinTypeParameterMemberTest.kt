...
class KotlinTypeParameterMemberTest {
    ...
    @Test fun goToDefinitionResolvesBoundMember() = runBlocking {
        ...
        val nameRef = generateSequence(node) { it.parent }.first { it.kind == dev.aetherstudioz.lang.dom.NodeKind.NAME_REF }
        val result = analyzer.resolve(nameRef)
        assertTrue(result is dev.aetherstudioz.lang.resolve.ResolveResult.Resolved, "b.idealTemperature should resolve to the bound member")
