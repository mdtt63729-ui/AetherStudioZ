...
class KotlinMetadataTest {
    ...
    fun decodedSupertypesCarryTheirTypeArguments() {
        ...
        val abstractList = decoded.supertypes.filterIsInstance<dev.aetherstudioz.lang.kotlin.symbols.KotlinType>()
        ...
        assertTrue(
            (abstractList.typeArguments.first() as? dev.aetherstudioz.lang.kotlin.symbols.KotlinType)?.isTypeParameter == true,
