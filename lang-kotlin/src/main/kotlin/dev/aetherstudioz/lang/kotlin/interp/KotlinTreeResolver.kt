package dev.aetherstudioz.lang.kotlin.interp
...
class KotlinTreeResolver(
     ...
     *  private cache (the standalone case, e.g. tests). See [dev.aetherstudioz.lang.kotlin.resolve.KotlinResolverCaches]. */
    caches: dev.aetherstudioz.lang.kotlin.resolve.KotlinResolverCaches? = null,
) {
    ...
    private fun classLoadCandidates(fqn: String): List<String> {
        ...
        fun add(f: String, depth: Int) {
            ...
            dev.aetherstudioz.lang.kotlin.symbols.Builtins.javaTypeFor(f)?.let { candidates += it } // JVM form preferred
            candidates += f
