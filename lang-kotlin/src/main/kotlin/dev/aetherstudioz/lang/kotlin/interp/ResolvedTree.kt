 ...
 *  binds it as `Array<T>`; see [dev.aetherstudioz.interp bindParams]) rather than binding a single value. */
 ...
 *  a same-module provider (over one [dev.aetherstudioz.lang.kotlin.symbols.KotlinSymbolService]) and a cross-module
 ...
 *  (over one [dev.aetherstudioz.lang.kotlin.symbols.KotlinSymbolService]) and a cross-module dispatcher (fanning out
