...
internal fun KotlinResolver.inferredReturnTypeForCall(
    ...
    (sym.declaration() as? dev.aetherstudioz.lang.kotlin.parse.KotlinDomNode)?.psi?.let { psi ->
...
internal fun KotlinResolver.objectLiteralType(e: KtObjectLiteralExpression): KotlinType =
    service.typeByFqn(dev.aetherstudioz.lang.kotlin.symbols.SourceIndexBuilder.localTypeFqn(e.objectDeclaration))
