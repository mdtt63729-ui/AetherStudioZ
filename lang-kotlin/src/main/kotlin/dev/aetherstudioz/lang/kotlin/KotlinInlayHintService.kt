...
class KotlinInlayHintService(
     ...
     * ([dev.aetherstudioz.lang.kotlin.symbols.JavaBytecode]) and the attached-source enrichment
     * ([dev.aetherstudioz.lang.kotlin.symbols.KotlinSymbolService]). When neither can, the name is a synthetic `p0`
