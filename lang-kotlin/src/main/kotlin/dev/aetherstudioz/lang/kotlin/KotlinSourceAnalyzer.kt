...
import dev.aetherstudioz.lang.kotlin.completion.KotlinCompletion
import dev.aetherstudioz.lang.kotlin.completion.KotlinCompletionItems
import dev.aetherstudioz.lang.kotlin.parse.KotlinDomNode
...
import dev.aetherstudioz.lang.kotlin.resolve.*
import dev.aetherstudioz.lang.kotlin.symbols.BuiltinStubRenderer
...
import dev.aetherstudioz.lang.resolve.SymbolFilter
...
import dev.aetherstudioz.lang.imports.ImportOrganizerService
...
import dev.aetherstudioz.lang.kotlin.interp.LazyPreviewDeclProvider
import dev.aetherstudioz.lang.kotlin.interp.PreviewFileModel
import dev.aetherstudioz.lang.kotlin.interp.PreviewInfo
import dev.aetherstudioz.lang.kotlin.interp.PreviewLazyFile
import dev.aetherstudioz.lang.kotlin.interp.PreviewLoweringDiskCache
import dev.aetherstudioz.lang.kotlin.interp.PreviewModel
import dev.aetherstudioz.lang.kotlin.interp.ResolvedClass
import dev.aetherstudioz.lang.kotlin.interp.ResolvedFunction
import dev.aetherstudioz.lang.resolve.DocFormat
import dev.aetherstudioz.lang.resolve.QuickDocInfo
import dev.aetherstudioz.lang.resolve.SourceDocProvider
import dev.aetherstudioz.lang.resolve.StructureItem
 ...
 * parse). Mirrors [dev.aetherstudioz.lang.jdt.JdtSourceAnalyzer]: built from a model-derived [CompilationContext],
...
class KotlinSourceAnalyzer(ctx: CompilationContext) : SourceAnalyzer, Disposable {
    ...
    @Volatile
    var syntheticMemberProviders: () -> List<dev.aetherstudioz.lang.kotlin.symbols.KotlinSyntheticMemberProvider> =
        { dev.aetherstudioz.lang.kotlin.symbols.BUILTIN_KOTLIN_SYNTHETIC_MEMBER_PROVIDERS }
    ...
    @Volatile
    var javaSourceMemberProvider: (String) -> List<dev.aetherstudioz.index.MemberValue>? = { null }
    ...
    private fun syncFocal(parsed: KotlinParsedFile) {
        runCatching {
            service.syncFocal(parsed.file.path, parsed.ktFile.text.hashCode()) {
                dev.aetherstudioz.lang.kotlin.symbols.SourceIndexBuilder.extractFrom(
                    parsed.ktFile,
                    parsed,
                    parsed.file.path
                )
     ...
     *  [dev.aetherstudioz.lang.kotlin.symbols.KotlinSymbolService.classpathIndexBuilding]. */
    ...
    override val inlayHints: dev.aetherstudioz.lang.hints.InlayHintService by lazy {
     ...
     * skipped, nothing can extend it) that actually has direct inheritors in the [dev.aetherstudioz.index.SubtypeIndex].
    ...
    fun declarationLocation(fqn: String): Pair<VirtualFile, Int>? {
        ...
        val kt = dev.aetherstudioz.lang.kotlin.parse.KotlinParserHost.parse(psf.file.name, psf.text)
    ...
    private fun typeRefFqnAt(ktFile: KtFile, leaf: PsiElement?): String? {
        ...
        val imports = ktFile.importDirectives.mapNotNull { imp ->
            imp.importedFqName?.asString()?.let {
                dev.aetherstudioz.lang.kotlin.symbols.ImportInfo(it, imp.aliasName, imp.isAllUnder)
            }
        }
        val ctx = dev.aetherstudioz.lang.kotlin.symbols.FileContext(ktFile.name, ktFile.packageFqName.asString(), imports)
