 ...
 * query both via [dev.aetherstudioz.index.ClassNameIndex] / [dev.aetherstudioz.index.SourceSymbolIndex] / … `.ALL` and merge.
 *
 ...
 *  side), matching [dev.aetherstudioz.lang.kotlin.symbols.SourceIndex]'s `collectClasses`. */
