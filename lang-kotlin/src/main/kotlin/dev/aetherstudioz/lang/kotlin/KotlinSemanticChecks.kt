...
import dev.aetherstudioz.lang.kotlin.analysis.KotlinChecker
import dev.aetherstudioz.lang.kotlin.parse.hasAncestor
import dev.aetherstudioz.lang.kotlin.parse.inTypeReference
import dev.aetherstudioz.lang.kotlin.parse.unwrapParen
import dev.aetherstudioz.lang.kotlin.resolve.*
import dev.aetherstudioz.lang.kotlin.symbols.Builtins
import dev.aetherstudioz.lang.kotlin.symbols.DefaultImports
...
import dev.aetherstudioz.lang.kotlin.symbols.OptInLevel
import dev.aetherstudioz.lang.kotlin.symbols.OptInMarker
...
internal class KotlinSemanticChecks(private val service: KotlinSymbolService) {
    ...
    /**
     * The semantic checkers, one per PSI element kind, run by a [dev.aetherstudioz.lang.kotlin.analysis.KotlinCheckerDriver]
    ...
    private fun previewMisuse(fn: KtNamedFunction): Diagnostic? {
        val previewAnn = fn.annotationEntries.firstOrNull { e ->
            ...
            n == "Preview" || (n != null && n in dev.aetherstudioz.lang.kotlin.interp.PreviewConstants.builtinMultiPreviews)
        } ?: return null
