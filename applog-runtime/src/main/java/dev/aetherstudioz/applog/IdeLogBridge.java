package dev.aetherstudioz.applog;
...
public final class IdeLogBridge {
    ...
    public static final String SINK_ACTION = "dev.aetherstudioz.applog.SINK";
    /** Interface token written into the submit transaction's Parcel. */
    public static final String BINDER_DESCRIPTOR = "dev.aetherstudioz.applog.IAppLogSink";
    ...
    public static synchronized void start(Context context) {
        ...
        String tok = System.getProperty("dev.aetherstudioz.applog.token", "");
