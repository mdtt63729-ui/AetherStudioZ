package dev.aetherstudioz.preview.bridge.widget
 ...
 * [renderContent] exposes the protected `onDraw` so the [dev.aetherstudioz.preview.ViewHost] adapter can run the
