...
internal object ResourceContextFactory {
    ...
    fun create(
        ...
        // to the host (`com.aetherstudioz.app`); the project package then collides with the host's and getIdentifier
        ...
        private val inflaterRef: LayoutInflater? by lazy {
            inflaterFactory?.let { f ->
                runCatching {
                    ...
                    dev.aetherstudioz.platform.log.Log.logger("ide.preview")
