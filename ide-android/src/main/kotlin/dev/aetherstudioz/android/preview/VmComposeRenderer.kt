 ...
 * the phase-B/B′ threading) into pixels. It is the counterpart to [dev.aetherstudioz.interp.compose.ComposePreviewRenderer]
...
class VmComposeRenderer(private val executor: VmLibraryExecutor) {
    ...
    private companion object {
        ...
        const val RENDER_HARNESS_FQN = "dev.aetherstudioz.interp.compose.VmComposeRenderHarness"
