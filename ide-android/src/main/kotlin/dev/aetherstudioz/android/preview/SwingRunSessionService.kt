...
import dev.aetherstudioz.awt.ModalPump
import dev.aetherstudioz.awt.ToolkitWindows
import dev.aetherstudioz.awt.Window
...
import dev.aetherstudioz.jvm.VmInterruptedException
import dev.aetherstudioz.jvm.interpretedConstructors
 ...
 * an [dev.aetherstudioz.preview.RCanvas], so a session is a [Bitmap], a [Canvas] over it, and a loop.
 *
...
class SwingRunSessionService : Service() {
    ...
    private companion object {
         ...
         * `dev.aetherstudioz.awt.` would be bridged rather than interpreted. Colliding with the IDE's own package is
