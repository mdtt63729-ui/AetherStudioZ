package dev.aetherstudioz.android.plugins
...
class ApkPluginSource(
    ...
    companion object {
        ...
        const val PLUGIN_ACTION = "dev.aetherstudioz.aetherstudioz.action.PLUGIN"

        /** The meta-data key pointing at the raw resource holding the plugin's TOML manifest. */
        const val META_MANIFEST = "dev.aetherstudioz.aetherstudioz.plugin.manifest"
