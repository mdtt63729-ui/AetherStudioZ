package dev.aetherstudioz.android.applog
 ...
 * transaction carries a `String[]` of wire payloads, routed to the active [dev.aetherstudioz.android.AppLogChannelImpl]
