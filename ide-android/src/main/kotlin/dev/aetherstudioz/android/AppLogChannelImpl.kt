...
import dev.aetherstudioz.core.AppLogChannel
import dev.aetherstudioz.core.AppLogEntry
import dev.aetherstudioz.core.AppLogEvent
import dev.aetherstudioz.core.AppLogSnapshot
import dev.aetherstudioz.core.AppLogWire
 ...
 * Binder (through the exported [dev.aetherstudioz.android.applog.AppLogSinkService]), decodes them with the pure
...
class AppLogChannelImpl : AppLogChannel {
    ...
    /**
     * A batch of wire payloads pushed by the bound bridge (via [dev.aetherstudioz.android.applog.AppLogSinkService]). A
 ...
 * ([dev.aetherstudioz.android.applog.AppLogSinkService]) always runs in the UI process and feeds this channel directly,
