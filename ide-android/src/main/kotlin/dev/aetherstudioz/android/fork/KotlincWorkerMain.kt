 ...
 * `dalvikvm64 -Xmx<n>m -D… -cp <the app's own APK> dev.aetherstudioz.android.fork.KotlincWorkerMain …` and then kept
 ...
 * `dev.aetherstudioz.kotlinc-art` instrumentation writes into those same classes, and (unlike a bare `.dex` file) the
...
object KotlincWorkerMain {
    ...
    private fun pluginLoader(opts: Map<String, String>): dev.aetherstudioz.lang.kotlin.compile.KotlinPluginLoader {
        ...
        return if (androidJar != null && cache != null && minApi != null) {
            ...
            dev.aetherstudioz.lang.kotlin.compile.DefaultKotlinPluginLoader
        }
    }
