package dev.aetherstudioz.android.fork

import android.content.Context
import dev.aetherstudioz.android.R8ForkSupport
import dev.aetherstudioz.lang.kotlin.compile.KotlinCompileRequest
import dev.aetherstudioz.lang.kotlin.compile.KotlinCompileResult
 ...
 * same reason [dev.aetherstudioz.android.ForkedR8Shrinker] forks R8.
 *
 ...
 * attributed to a tool VM rather than to the app by `dev.aetherstudioz.platform.ForkedToolVm.isToolVmCrash`.
 */
class ForkedKotlinCompiler(
     ...
     * platform, the ART shims baked in by the `dev.aetherstudioz.kotlinc-art` instrumentation, AND the resources the
