...
import dev.aetherstudioz.interp.compose.ComposeRuntime
import dev.aetherstudioz.interp.compose.VmComposeHost
 ...
 *       -Pandroid.testInstrumentationRunnerArguments.class=dev.aetherstudioz.android.spike.VmSourceComposableArtSpike
 *     adb logcat -d -s VmSourceComposableArt
 */
@RunWith(AndroidJUnit4::class)
class VmSourceComposableArtSpike {

    private val FIXTURE = "dev.aetherstudioz.interp.compose.spike.ComposerThreadingSpikeFixture"
    private val PROBES = "dev.aetherstudioz.interp.compose.spike.ProbesKt"
    ...
    private fun executor(): VmLibraryExecutor {
        ...
        return VmLibraryExecutor(
            ...
            projectPreferredPrefixes = listOf(
                ...
                "dev.aetherstudioz.interp.compose.spike.",
            ),
