 ...
 *       -Pandroid.testInstrumentationRunnerArguments.class=dev.aetherstudioz.android.spike.VmTextFieldArtSpike
...
class VmTextFieldArtSpike {
    ...
    private fun composeTextish(ownerFqn: String, fn: String): Throwable? {
        ...
        executor.lambdaErrorSink = { t ->
            ...
            // host loader. Frames mentioning dev.aetherstudioz.jvm/interp reveal the bridge boundary (peer vs bridgeCall vs cast).
