 ...
 * ([dev.aetherstudioz.jvm.Interpreter]'s `boxLambdaReturn`): a Kotlin `{ false }` compiles to an indy whose impl returns
 ...
 * TheBridge`; this runs the SAME `dev.aetherstudioz.jvm.kfixtures.KFxKt` bytecode on ART with the on-device
 ...
 *       -Pandroid.testInstrumentationRunnerArguments.class=dev.aetherstudioz.android.spike.VmPrimitiveLambdaBoxingArtSpike
 */
