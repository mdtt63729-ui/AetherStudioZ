...
import dev.aetherstudioz.android.R8ForkSupport
 ...
 * way [dev.aetherstudioz.android.ForkedR8Shrinker] already runs R8.
 *
 ...
 * the `dev.aetherstudioz.kotlinc-art` AGP instrumentation writes into it (`PathUtilSelfLocatePass`,
 ...
 * path never reaches it, because [dev.aetherstudioz.lang.kotlin.compile.KotlinJvmCompiler] calls
 ...
 *       -Pandroid.testInstrumentationRunnerArguments.class=dev.aetherstudioz.android.spike.ForkedKotlincArtSpike
...
class ForkedKotlincArtSpike {
     ...
     * [dev.aetherstudioz.lang.kotlin.compile.KotlinJvmCompiler] builds in-process: `-no-jdk` with `android.jar` folded
     ...
     * [dev.aetherstudioz.lang.kotlin.compile.KotlinEnvironmentKeepAlive] exists to avoid across in-process compiles.
     *
    ...
    /**
     * The CLI form of the arguments [dev.aetherstudioz.lang.kotlin.compile.KotlinJvmCompiler] builds programmatically.
