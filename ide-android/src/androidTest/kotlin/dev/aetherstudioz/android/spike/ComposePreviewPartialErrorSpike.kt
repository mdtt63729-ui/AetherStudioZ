 ...
 *       -Pandroid.testInstrumentationRunnerArguments.class=dev.aetherstudioz.android.spike.ComposePreviewPartialErrorSpike
 */
...
class ComposePreviewPartialErrorSpike {
    ...
    private fun throwingCall() = RNode.Call(
        ResolvedCallable.Library(
            "definitelyNotAThing", "dev.aetherstudioz.does.not.Exist", "definitelyNotAThing", emptyList(),
