...
import dev.aetherstudioz.android.AndroidPreviewResources
...
import dev.aetherstudioz.ui.editor.preview.UiDrawablePainter
 ...
 * production resolver ([AndroidPreviewResources]) over a REAL [dev.aetherstudioz.android.support.resources.ResourceRepository]
 ...
 *       -Pandroid.testInstrumentationRunnerArguments.class=dev.aetherstudioz.android.spike.ResourcePreviewOnDeviceTest
 */
...
class ResourcePreviewOnDeviceTest {
    ...
    private fun record(fn: String, arg: RNode) = RNode.Call(
        lib(fn, "dev.aetherstudioz.android.spike.ResourcePreviewOnDeviceTestKt"), DispatchKind.TOP_LEVEL, receiver = null,
