package dev.aetherstudioz.android.spike
...
import dev.aetherstudioz.android.DexPeerFactory
import dev.aetherstudioz.android.preview.AndroidRenderBackend
import dev.aetherstudioz.awt.ToolkitWindows
import dev.aetherstudioz.awt.interp.AwtNameRemapper
import dev.aetherstudioz.jvm.ClassBytesSource
import dev.aetherstudioz.jvm.InterpretPolicy
import dev.aetherstudioz.jvm.ReflectiveBridge
import dev.aetherstudioz.jvm.Vm
import dev.aetherstudioz.jvm.interpretedMethods
import dev.aetherstudioz.preview.RCanvas
import dev.aetherstudioz.preview.RGraphics
import dev.aetherstudioz.preview.RImage
import dev.aetherstudioz.preview.RPaint
import dev.aetherstudioz.preview.RPath
import dev.aetherstudioz.swing.JButton
import dev.aetherstudioz.swing.JFrame
...
/**
 * On-device (ART) proof that a Java **Swing** program runs on AetherStudioZ.
 *
 ...
 *     toolkit's `dev.aetherstudioz.swing.JPanel`, D8-compiled at runtime, whose `paintComponent` override dispatches
 ...
 *       -Pandroid.testInstrumentationRunnerArguments.class=dev.aetherstudioz.android.spike.AwtToolkitArtSpike
...
class AwtToolkitArtSpike {
    ...
    fun anInterpretedSwingProgramDrawsOnArt() {
        ...
        assertEquals(
            ...
            "dev.aetherstudioz.swing.JPanel",
