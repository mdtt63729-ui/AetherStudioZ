 ...
 *       -Pandroid.testInstrumentationRunnerArguments.class=dev.aetherstudioz.android.spike.XmlPsiArtSpikeTest
        ...
        try {
            ...
            fail(
                "XML PSI failed on ART: ${t.javaClass.name}: ${t.message}\n" +
                    "Add a pass to dev.aetherstudioz.build.kotlinc.ArtPatchPasses (or a shipped javax/StAX type / " +
