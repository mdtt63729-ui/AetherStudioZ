...
import dev.aetherstudioz.android.spike.SpikeComposeActivity
 ...
 *       -Pandroid.testInstrumentationRunnerArguments.class=dev.aetherstudioz.android.bench.ComposeInterpreterBenchmarkTest
...
class ComposeInterpreterBenchmarkTest {
    ...
    private fun emptyClasspathContext(srcDir: Path): CompilationContext = object : CompilationContext {
        ...
        override val processors = emptyList<dev.aetherstudioz.lang.AnnotationProcessor>()
    }
