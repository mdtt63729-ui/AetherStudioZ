...
plugins {
    ...
    // ALL — see buildSrc dev.aetherstudioz.build.kotlinc). No-op until the device spike (KotlinCompilerArtSpikeTest)
    // discovers the first breakage and a pass is added to ArtPatchPasses.
    id("dev.aetherstudioz.kotlinc-art")
...
// jar is D8-dexed into a standalone r8.dex.zip asset that `dev.aetherstudioz.android.R8ForkSupport` extracts and puts
// on `dalvikvm64 -Xmx<n>m -cp <asset> com.android.tools.r8.R8 …`.
//
// A fork CAN load the app's own APK instead (the persistent Kotlin compiler VM in `dev.aetherstudioz.android.fork`
...
// NOTE: the `dev.aetherstudioz.ui.generated.resources` segment must match :ide-ui's `packageOfResClass`.
val bundleComposeFontsAsset = tasks.register<Copy>("bundleComposeFontsAsset") {
    ...
    into(layout.buildDirectory.dir("compose-fonts-asset/composeResources/dev.aetherstudioz.ui.generated.resources/font"))
}
...
val bundleComposeDrawablesAsset = tasks.register<Copy>("bundleComposeDrawablesAsset") {
    ...
    into(layout.buildDirectory.dir("compose-drawables-asset/composeResources/dev.aetherstudioz.ui.generated.resources/drawable"))
}
...
android {
    namespace = "dev.aetherstudioz.android"
    compileSdk = 36
    compileSdkMinor = 1

    defaultConfig {
        // The Play Store identity (immutable once published). The Kotlin source package (namespace,
        // above) stays dev.aetherstudioz.android — that's an internal build detail, independent of applicationId.
        applicationId = "com.aetherstudioz.app"
...
val bundleComposeStringAsset = tasks.register<Copy>("bundleComposeStringAsset") {
    ...
    from(project(":ide-ui").layout.buildDirectory.dir("processedResources/desktop/main/composeResources/dev.aetherstudioz.ui.generated.resources")) {
        include("values*/**/*.cvr")
    }
    into(layout.buildDirectory.dir("compose-strings-asset/composeResources/dev.aetherstudioz.ui.generated.resources"))
}

// The SAME Android packaging gap, for :agent-ui's OWN compose-resource strings (the chat_* i18n keys, which
// live in this module's composeResources under package dev.aetherstudioz.agent.ui.generated.resources — migrated out of
...
// dev.aetherstudioz.agent.ui.generated.resources/values/strings.commonMain.cvr`. Mirrors bundleComposeStringAsset.
val bundleAgentUiComposeStringAsset = tasks.register<Copy>("bundleAgentUiComposeStringAsset") {
    ...
    from(project(":agent-ui").layout.buildDirectory.dir("processedResources/desktop/main/composeResources/dev.aetherstudioz.agent.ui.generated.resources")) {
        include("values*/**/*.cvr")
    }
    into(layout.buildDirectory.dir("agent-ui-strings-asset/composeResources/dev.aetherstudioz.agent.ui.generated.resources"))
}

// The SAME Android packaging gap, for :vcs-ui's OWN compose-resource strings (the vcs_* i18n keys, under
// package dev.aetherstudioz.vcs.ui.generated.resources). Without this the Git panel crashes on device the moment it
// renders, with `MissingResourceException: composeResources/dev.aetherstudioz.vcs.ui.generated.resources/values/
...
val bundleVcsUiComposeStringAsset = tasks.register<Copy>("bundleVcsUiComposeStringAsset") {
    ...
    from(project(":vcs-ui").layout.buildDirectory.dir("processedResources/desktop/main/composeResources/dev.aetherstudioz.vcs.ui.generated.resources")) {
        include("values*/**/*.cvr")
    }
    into(layout.buildDirectory.dir("vcs-ui-strings-asset/composeResources/dev.aetherstudioz.vcs.ui.generated.resources"))
}
...
dependencies {
    ...
    // dev.aetherstudioz.interp.compose — KMP, re-exporting :interp-core): drives a ResolvedTree against the real
    ...
    // The bytecode VM: the real-view layout preview interprets library/user View classes (dev.aetherstudioz.jvm.Vm via
    ...
    // program's window class reaches ART as a peer that SUBCLASSES `dev.aetherstudioz.swing.JPanel`, so the toolkit must
