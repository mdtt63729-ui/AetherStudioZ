package dev.aetherstudioz.model.sync
 ...
 * [dev.aetherstudioz.model.ProjectModelTransaction], needs no knowledge of persistence or the message bus, is
 * testable as a pure function, and its output can be cached and diffed between syncs.
 *
 * Building is a separate concern ([dev.aetherstudioz.build.BuildSystem]): the native project model has no importer,
 ...
 * records its [id] as the project's [dev.aetherstudioz.model.Project.buildSystemId], and re-runs [resolve] whenever a
...
/**
 * One module. [typeId] is resolved against [dev.aetherstudioz.model.ModuleTypeExtensionPoint] (`android-app`,
...
/** A dependency declaration. Mirrors [dev.aetherstudioz.model.OrderEntry] without binding to the live model. */
