...
interface Workspace {
     ...
     * [dev.aetherstudioz.platform.ServiceContainer] must override it (the IDE's does).
     */
...
interface WorkspaceTransaction {
     ...
     *  workspace first imported natively that a [dev.aetherstudioz.model.sync.ProjectImporter] has since claimed. */
