...
/**
 * `java.awt.Color`. Packed as `0xAARRGGBB` in [rgb], the same packing [dev.aetherstudioz.preview.RPaint] uses, so a
...
/**
 * `java.awt.FontMetrics`. Measurement is the backend's job (an [dev.aetherstudioz.preview.RGraphics] knows the real
