package dev.aetherstudioz.awt

import dev.aetherstudioz.awt.event.MouseEvent
import dev.aetherstudioz.awt.event.MouseListener
...
open class Component {
    ...
    private val keyListeners = ArrayList<dev.aetherstudioz.awt.event.KeyListener>()

    fun addKeyListener(l: dev.aetherstudioz.awt.event.KeyListener?) {
        if (l != null) keyListeners.add(l)
    }

    fun removeKeyListener(l: dev.aetherstudioz.awt.event.KeyListener?) {
        if (l != null) keyListeners.remove(l)
    }

    fun getKeyListeners(): Array<dev.aetherstudioz.awt.event.KeyListener> = keyListeners.toTypedArray()
    ...
    private val motionListeners = ArrayList<dev.aetherstudioz.awt.event.MouseMotionListener>()
    private val wheelListeners = ArrayList<dev.aetherstudioz.awt.event.MouseWheelListener>()

    fun addMouseMotionListener(l: dev.aetherstudioz.awt.event.MouseMotionListener?) {
        if (l != null) motionListeners.add(l)
    }

    fun removeMouseMotionListener(l: dev.aetherstudioz.awt.event.MouseMotionListener?) {
        if (l != null) motionListeners.remove(l)
    }

    fun addMouseWheelListener(l: dev.aetherstudioz.awt.event.MouseWheelListener?) {
        if (l != null) wheelListeners.add(l)
    }

    fun removeMouseWheelListener(l: dev.aetherstudioz.awt.event.MouseWheelListener?) {
    ...
    protected open fun processKeyEvent(e: dev.aetherstudioz.awt.event.KeyEvent) {
        for (l in keyListeners.toList()) {
            when (e.id) {
                dev.aetherstudioz.awt.event.KeyEvent.KEY_PRESSED -> l.keyPressed(e)
                dev.aetherstudioz.awt.event.KeyEvent.KEY_RELEASED -> l.keyReleased(e)
                dev.aetherstudioz.awt.event.KeyEvent.KEY_TYPED -> l.keyTyped(e)
            }
        }
    }

    /** Entry point for the surface, which is outside this class's package in AWT terms. */
    internal fun dispatchKeyEvent(e: dev.aetherstudioz.awt.event.KeyEvent) = processKeyEvent(e)
    ...
    protected open fun processMouseWheelEvent(e: dev.aetherstudioz.awt.event.MouseWheelEvent): Boolean {
    ...
    internal fun dispatchWheelEvent(e: dev.aetherstudioz.awt.event.MouseWheelEvent): Boolean = processMouseWheelEvent(e)
}
