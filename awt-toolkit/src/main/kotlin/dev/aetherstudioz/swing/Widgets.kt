...
import dev.aetherstudioz.awt.Container
import dev.aetherstudioz.awt.Dimension
import dev.aetherstudioz.awt.Font
import dev.aetherstudioz.awt.Graphics
import dev.aetherstudioz.awt.Insets
import dev.aetherstudioz.awt.event.ActionEvent
import dev.aetherstudioz.awt.event.ActionListener
...
open class JComponent : Container() {
    ...
    private var border: dev.aetherstudioz.swing.border.Border? = null
    ...
    open fun getBorder(): dev.aetherstudioz.swing.border.Border? = border

    open fun setBorder(value: dev.aetherstudioz.swing.border.Border?) {
        border = value
        invalidate()
        repaint()
    }
...
open class JPanel @JvmOverloads constructor(layout: dev.aetherstudioz.awt.LayoutManager? = dev.aetherstudioz.awt.FlowLayout()) : JComponent() {
    init {
        setLayout(layout)
