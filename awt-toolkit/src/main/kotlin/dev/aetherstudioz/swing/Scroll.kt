package dev.aetherstudioz.swing

import dev.aetherstudioz.awt.Color
import dev.aetherstudioz.awt.Component
import dev.aetherstudioz.awt.Dimension
import dev.aetherstudioz.awt.Graphics
import dev.aetherstudioz.awt.Point
import dev.aetherstudioz.awt.event.MouseWheelEvent
...
open class JSlider @JvmOverloads constructor(
    ...
    private val changeListeners = ArrayList<dev.aetherstudioz.swing.event.ChangeListener>()
    ...
    open fun setValue(v: Int) {
        ...
        current = next
        val e = dev.aetherstudioz.swing.event.ChangeEvent(this)
    ...
    fun addChangeListener(l: dev.aetherstudioz.swing.event.ChangeListener?) {
        if (l != null) changeListeners.add(l)
    }

    override fun processMouseEvent(e: dev.aetherstudioz.awt.event.MouseEvent) {
        super.processMouseEvent(e)
        if (e.id == dev.aetherstudioz.awt.event.MouseEvent.MOUSE_PRESSED) setValueFrom(e.x)
    }

    override fun processMouseMotionEvent(e: dev.aetherstudioz.awt.event.MouseEvent) {
        super.processMouseMotionEvent(e)
        if (e.id == dev.aetherstudioz.awt.event.MouseEvent.MOUSE_DRAGGED) setValueFrom(e.x)
    }
 ...
 */
class BoxLayout(private val target: Component?, private val axis: Int) : dev.aetherstudioz.awt.LayoutManager {

    override fun layoutContainer(parent: dev.aetherstudioz.awt.Container) {
    ...
    override fun preferredLayoutSize(parent: dev.aetherstudioz.awt.Container): Dimension {
        val insets = parent.getInsets()
        var main = 0
        var cross = 0
        for (c in parent.components()) {
