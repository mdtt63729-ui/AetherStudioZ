...
// over -- `java.awt.Component` -> `dev.aetherstudioz.awt.Component`, `javax.swing.JFrame` -> `dev.aetherstudioz.swing.JFrame` --
...
val swingApiStubsJar = tasks.register<JavaExec>("swingApiStubsJar") {
    ...
    mainClass.set("dev.aetherstudioz.awt.interp.SwingApiStubs")
