...
[![CI](https://img.shields.io/github/actions/workflow/status/aetherstudioz/AetherStudioZ/ci.yml?branch=main&label=CI&logo=githubactions&logoColor=white)](https://github.com/aetherstudioz/AetherStudioZ/actions)
[![Tests](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/aetherstudioz/AetherStudioZ/main/.github/badges/tests.json)](https://github.com/aetherstudioz/AetherStudioZ/actions)
[![Benchmarks](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/aetherstudioz/AetherStudioZ/main/.github/badges/benchmarks.json)](#benchmarks)
[![Release](https://img.shields.io/github/v/release/aetherstudioz/AetherStudioZ?display_name=tag&logo=github&sort=semver)](https://github.com/aetherstudioz/AetherStudioZ/releases)
[![License](https://img.shields.io/github/license/aetherstudioz/AetherStudioZ)](LICENSE)
[![Stars](https://img.shields.io/github/stars/aetherstudioz/AetherStudioZ?style=flat&logo=github)](https://github.com/aetherstudioz/AetherStudioZ/stargazers)
[![Forks](https://img.shields.io/github/forks/aetherstudioz/AetherStudioZ?style=flat&logo=github)](https://github.com/aetherstudioz/AetherStudioZ/network/members)
...
<img src="docs/assets/01-ide-on-phone.png" alt="AetherStudioZ running on a phone" width="320" />

</div>

## What is AetherStudioZ?

AetherStudioZ is an extensible IDE framework that runs **entirely on device** (Android/ART) and edits and
builds Android/Java projects **without hosting Gradle**. A full Gradle runtime is too heavy for a phone,
so AetherStudioZ models projects itself, mimics Gradle's incremental task engine without the Gradle daemon,
...
AetherStudioZ tracks completion quality, editor latency, indexing, and build performance against committed
...
AetherStudioZ is free software licensed under the **GNU General Public License v3.0 or later**
...
`index-api`, `analysis-api`, `build-api`), published under `io.github.aetherstudioz`, add the Classpath
...
Join the **[AetherStudioZ Discord](https://discord.gg/y2gycT6pDW)** to chat, get help, report bugs, and
