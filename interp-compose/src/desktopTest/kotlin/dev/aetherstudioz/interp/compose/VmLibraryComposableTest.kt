...
class VmLibraryComposableTest {
    ...
    private val pkg = "dev.aetherstudioz.interp.compose.libfixture"
    ...
    @Test fun interpretedLambdaFailureInvokedByRealCodeIsRecordedNotThrown() {
        ...
        val throwing = object : InterpretedLambda {
            ...
            override fun invoke(args: List<Any?>): Any? =
                throw dev.aetherstudioz.interp.InterpreterException("no readable property `value` on kotlin.Unit")
        }
        val call = RNode.Call(
            callee = ResolvedCallable.Library(
                displayName = "runCallback", ownerFqn = "dev.aetherstudioz.interp.compose.VmLibraryComposableTestKt",
