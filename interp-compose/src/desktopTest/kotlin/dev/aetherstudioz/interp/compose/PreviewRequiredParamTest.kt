...
class PreviewRequiredParamTest {
    ...
    private fun entry(code: String, keyPrefix: String): Pair<dev.aetherstudioz.lang.kotlin.interp.ResolvedFunction, Map<String, dev.aetherstudioz.lang.kotlin.interp.ResolvedFunction>> {
