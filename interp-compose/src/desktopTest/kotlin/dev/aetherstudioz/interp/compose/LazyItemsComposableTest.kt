...
class LazyItemsComposableTest {
    ...
    fun composableContentLambdaPassedToANonComposableBuilderIsComposerThreaded() {
        ...
        val fakeItemFacade = "dev.aetherstudioz.interp.compose.InlineOnlyScopeFunctionTestKt"
    ...
    private val itemFacade = "dev.aetherstudioz.interp.compose.LazyItemsComposableTestKt"
