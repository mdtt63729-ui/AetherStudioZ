...
class ComposableAbiDefaultsTest {
    ...
    fun cardOnClickBindsToANonNullProxyInvocableAfterComposition() {
        ...
        var ran = false
        val onClick = object : dev.aetherstudioz.interp.InterpretedLambda {
            override val paramCount = 0
            override fun invoke(args: List<Any?>): Any? { ran = true; return null }
        }
        val content = object : dev.aetherstudioz.interp.InterpretedLambda {
            override val paramCount = 0
            override fun invoke(args: List<Any?>): Any? = null
        }
        val facade = "dev.aetherstudioz.interp.compose.ComposableAbiDefaultsTestKt"
        val span = dev.aetherstudioz.lang.kotlin.interp.SourceSpan(0, 0)
        val callee = dev.aetherstudioz.lang.kotlin.interp.ResolvedCallable.Library(
            displayName = "CardLike", ownerFqn = facade, methodName = "CardLike",
            paramTypes = listOf(
                dev.aetherstudioz.lang.kotlin.symbols.KotlinType("kotlin.Function0"),
                dev.aetherstudioz.lang.kotlin.symbols.KotlinType("kotlin.Boolean"),
                dev.aetherstudioz.lang.kotlin.symbols.KotlinType("kotlin.Function0"),
            ),
        ...
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            callee, dev.aetherstudioz.lang.kotlin.interp.DispatchKind.TOP_LEVEL, receiver = null,
            args = listOf(
                dev.aetherstudioz.lang.kotlin.interp.RArg(dev.aetherstudioz.lang.kotlin.interp.RNode.Const(null, null, span), "onClick", false, false),
                dev.aetherstudioz.lang.kotlin.interp.RArg(dev.aetherstudioz.lang.kotlin.interp.RNode.Const(null, null, span), null, false, true),
            ),
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(41), source = span,
        )
    ...
    fun wrongDeclaredParamCountStillResolvesViaRuntimeComposerIndex() {
        ...
        composeOnce {
            ...
            try {
                ComposableAbi.call(
                    ownerFqn = "dev.aetherstudioz.interp.compose.ComposableAbiDefaultsTestKt",
                    method = "RecordValues",
    ...
    fun trailingContentLambdaBindsToLastParamWhileOthersDefault() {
        ...
        var ran = false
        val lambda = object : dev.aetherstudioz.interp.InterpretedLambda {
            override val paramCount = 0
            override fun invoke(args: List<Any?>): Any? { ran = true; return null }
        }
        composeOnce {
    ...
    private fun contentProxy(lambda: dev.aetherstudioz.interp.InterpretedLambda, fi: Class<*>, valueClassReturn: Class<*>? = null): Any =
    ...
    fun realTransformedComposableIsDetectedByMetadataDecode() {
        ...
        val decoded = dev.aetherstudioz.lang.kotlin.symbols.KotlinMetadata.decode(bytes, null)
    ...
    fun misdetectedComposableStillRendersViaDispatcher() {
        ...
        val callee = dev.aetherstudioz.lang.kotlin.interp.ResolvedCallable.Library(
            ...
            paramTypes = listOf(
                dev.aetherstudioz.lang.kotlin.symbols.KotlinType("kotlin.String"),
                dev.aetherstudioz.lang.kotlin.symbols.KotlinType("kotlin.Int"),
                dev.aetherstudioz.lang.kotlin.symbols.KotlinType("kotlin.Boolean"),
            ),
        ...
        val span = dev.aetherstudioz.lang.kotlin.interp.SourceSpan(0, 0)
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            callee, dev.aetherstudioz.lang.kotlin.interp.DispatchKind.TOP_LEVEL, receiver = null, args = emptyList(),
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(7), source = span,
        )
        val dispatcher = ComposeDispatcher()
        composeOnce {
            dispatcher.composer = currentComposer
    ...
    fun composeDispatcherReordersNamedArguments() {
        ...
        fun arg(name: String, v: Any?) =
            dev.aetherstudioz.lang.kotlin.interp.RArg(dev.aetherstudioz.lang.kotlin.interp.RNode.Const(v, null, span), name)
        val callee = dev.aetherstudioz.lang.kotlin.interp.ResolvedCallable.Library(
            displayName = "RecordValues", ownerFqn = facade, methodName = "RecordValues",
            paramTypes = listOf(
                dev.aetherstudioz.lang.kotlin.symbols.KotlinType("kotlin.String"),
        ...
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            ...
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(9), source = span,
        )
        val dispatcher = ComposeDispatcher()
        composeOnce {
            dispatcher.composer = currentComposer
    ...
    fun composableMemberCallOnAnObjectThreadsTheComposer() {
        ...
        val facade = "dev.aetherstudioz.interp.compose.Defaults"
        val span = dev.aetherstudioz.lang.kotlin.interp.SourceSpan(0, 0)
        fun arg(name: String, v: Any?) =
            dev.aetherstudioz.lang.kotlin.interp.RArg(dev.aetherstudioz.lang.kotlin.interp.RNode.Const(v, null, span), name)
        val callee = dev.aetherstudioz.lang.kotlin.interp.ResolvedCallable.Library(
        ...
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            callee, dev.aetherstudioz.lang.kotlin.interp.DispatchKind.MEMBER, receiver = null,
            args = listOf(arg("content", "C")), // omit the leading `container` default
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(11), source = span,
        )
        val dispatcher = ComposeDispatcher()
        var result: Any? = null
        composeOnce {
    ...
    fun extensionComposableThreadsTheComposerWithReceiverAsFirstParam() {
        ...
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            callee, dev.aetherstudioz.lang.kotlin.interp.DispatchKind.EXTENSION, receiver = null,
            args = listOf(dev.aetherstudioz.lang.kotlin.interp.RArg(dev.aetherstudioz.lang.kotlin.interp.RNode.Const(true, null, span))),
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(13), source = span,
        )
        val dispatcher = ComposeDispatcher()
        composeOnce {
            dispatcher.composer = currentComposer
    ...
    fun previewRenderErrorIsCaughtAndReportedNotThrown() {
        ...
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            callee, dev.aetherstudioz.lang.kotlin.interp.DispatchKind.TOP_LEVEL, receiver = null, args = emptyList(),
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(0), source = span,
        )
        val body = dev.aetherstudioz.lang.kotlin.interp.RNode.Block(listOf(call), isExpression = false, source = span)
        val entry = dev.aetherstudioz.lang.kotlin.interp.ResolvedFunction("Boom", emptyList(), body, emptyList())
    ...
    fun inParensLambdaArgBindsPositionallyNotToTheLastParam() {
        ...
        fun arg(name: String, v: dev.aetherstudioz.lang.kotlin.interp.RNode) = dev.aetherstudioz.lang.kotlin.interp.RArg(v, name, false, false)
        val callee = dev.aetherstudioz.lang.kotlin.interp.ResolvedCallable.Library(
            displayName = "Toggle", ownerFqn = facade, methodName = "Toggle",
            paramTypes = listOf(
                dev.aetherstudioz.lang.kotlin.symbols.KotlinType("kotlin.Boolean"),
                dev.aetherstudioz.lang.kotlin.symbols.KotlinType("kotlin.Function1"),
                dev.aetherstudioz.lang.kotlin.symbols.KotlinType("dev.aetherstudioz.interp.compose.ToggleSource"),
            ),
            isStatic = true, isConstructor = false, isInline = false, isComposable = true,
        ...
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            callee, dev.aetherstudioz.lang.kotlin.interp.DispatchKind.TOP_LEVEL, receiver = null,
            args = listOf(arg("checked", dev.aetherstudioz.lang.kotlin.interp.RNode.Const(true, null, span)), arg("onChange", dev.aetherstudioz.lang.kotlin.interp.RNode.Const(null, null, span))),
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(21), source = span,
        )
        val dispatcher = ComposeDispatcher()
        composeOnce {
            dispatcher.composer = currentComposer
    ...
    fun overloadSelectionUsesTheSameTrailingLambdaRuleAsBinding() {
        ...
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            callee, dev.aetherstudioz.lang.kotlin.interp.DispatchKind.TOP_LEVEL, receiver = null,
            args = listOf(arg("value", dev.aetherstudioz.lang.kotlin.interp.RNode.Const("hi", null, span)), arg("onValueChange", dev.aetherstudioz.lang.kotlin.interp.RNode.Const(null, null, span))),
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(23), source = span,
        )
        val dispatcher = ComposeDispatcher()
        composeOnce {
            dispatcher.composer = currentComposer
    ...
    private fun anyProxy(lambda: dev.aetherstudioz.interp.InterpretedLambda, fi: Class<*>, valueClassReturn: Class<*>? = null): Any =
    ...
    fun constructorOmittingDefaultedValueClassParamsRoutesThroughTheInitDefaultSynthetic() {
        ...
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            callee, dev.aetherstudioz.lang.kotlin.interp.DispatchKind.CONSTRUCTOR, receiver = null,
            args = listOf(dev.aetherstudioz.lang.kotlin.interp.RArg(dev.aetherstudioz.lang.kotlin.interp.RNode.Const("custom", null, span), name = "name")),
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(31), source = span,
        )
    ...
    fun constructorAcceptsAnUnboxedValueClassArgAndDefaultsAnOmittedMiddleParam() {
        ...
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            ...
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(33), source = span,
        )
    ...
    fun constructorBoxesAnUnboxedValueClassArgForANullableValueClassParam() {
        ...
        val call = dev.aetherstudioz.lang.kotlin.interp.RNode.Call(
            callee, dev.aetherstudioz.lang.kotlin.interp.DispatchKind.CONSTRUCTOR, receiver = null,
            args = listOf(dev.aetherstudioz.lang.kotlin.interp.RArg(dev.aetherstudioz.lang.kotlin.interp.RNode.Const(0x0000FFL, null, span), name = "tint")),
            callSiteKey = dev.aetherstudioz.lang.kotlin.interp.CallSiteKey(35), source = span,
        )
