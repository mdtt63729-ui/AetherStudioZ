...
class LazyScopeComposableGuardTest {
    ...
    private val lazyFacade = "dev.aetherstudioz.interp.compose.LazyItemsComposableTestKt"
    private val itemFacade = "dev.aetherstudioz.interp.compose.InlineOnlyScopeFunctionTestKt"
    ...
    fun composableInsideItemsContentStillComposes() {
        ...
        val fakeItemsCall = RNode.Call(
            ResolvedCallable.Library(
                displayName = "fakeItems", ownerFqn = "dev.aetherstudioz.interp.compose.FakeLazyScope", methodName = "fakeItems",
