...
class VarargComposableTest {
    ...
    private val facade = "dev.aetherstudioz.interp.compose.InlineOnlyScopeFunctionTestKt"
    ...
    fun nonLastVarargComposablePacksItsLooseArgs() {
        ...
        val provide = RNode.Call(
            ResolvedCallable.Library(
                displayName = "FakeProvide", ownerFqn = "dev.aetherstudioz.interp.compose.VarargComposableTestKt", methodName = "FakeProvide",
                paramTypes = listOf(KotlinType("dev.aetherstudioz.interp.compose.FakeProvided"), KotlinType("kotlin.Function0")),
