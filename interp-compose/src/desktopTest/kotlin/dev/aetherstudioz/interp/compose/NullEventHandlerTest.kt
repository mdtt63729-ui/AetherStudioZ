...
/**
 * Regression (the reported "clicking a compose menu item crashes AetherStudioZ"): when a previewed composable's
...
class NullEventHandlerTest {
    ...
    private val facade = "dev.aetherstudioz.interp.compose.NullEventHandlerTestKt"
