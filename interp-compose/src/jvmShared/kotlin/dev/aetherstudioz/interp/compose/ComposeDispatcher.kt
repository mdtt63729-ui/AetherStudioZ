...
import dev.aetherstudioz.interp.ComposablePropertyValue
import dev.aetherstudioz.interp.Dispatcher
import dev.aetherstudioz.interp.ExtensionPropertyValue
...
import dev.aetherstudioz.interp.LambdaProxyStrategy
import dev.aetherstudioz.interp.LibraryExecutor
import dev.aetherstudioz.interp.OmittedArg
...
import dev.aetherstudioz.interp.reorderNamedArgs
        ...
        Proxy.newProxyInstance(
            ...
            when (method.name) {
                ...
                "invoke" -> {
                    ...
                    // thread under a managed [dev.aetherstudioz.interp.SuspendContext] instead of running synchronously on the
