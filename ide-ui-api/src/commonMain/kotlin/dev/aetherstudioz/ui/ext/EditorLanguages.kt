 ...
 * a language wanting real structure contributes a `dev.aetherstudioz.lang.LanguageBackend`, whose semantic highlighting
 * and folding then layer on top of this.
 */
class EditorLanguageProfile(
    /** Matches the `dev.aetherstudioz.lang.LanguageId` the engine routes this language by, e.g. `"mylang"`. */
    val id: String,
