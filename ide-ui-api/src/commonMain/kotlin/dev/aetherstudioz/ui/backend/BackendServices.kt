...
interface ProjectService {
    ...
    /**
     * Convert the open Gradle compatibility-mode project to a native AetherStudioZ project: the leftover Gradle
     ...
     * actually apply to it. A AetherStudioZ workspace is adopted as-is and has no compatibility/convert choice
     ...
     * [projectEpoch]). A AetherStudioZ workspace is copied verbatim; a foreign build system (Gradle today) is
