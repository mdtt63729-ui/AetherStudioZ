...
import dev.aetherstudioz.preview.AttrReader
import dev.aetherstudioz.preview.MeasureSpec
import dev.aetherstudioz.preview.PaintStyle
import dev.aetherstudioz.preview.Props
import dev.aetherstudioz.preview.RCanvas
import dev.aetherstudioz.preview.RenderContext
import dev.aetherstudioz.preview.RenderNode
import dev.aetherstudioz.preview.Renderer
import dev.aetherstudioz.preview.RendererRegistry
import dev.aetherstudioz.preview.ResolvedValue
import dev.aetherstudioz.preview.Size
import dev.aetherstudioz.preview.ValueFormat
...
internal fun drawBackground(node: RenderNode, canvas: RCanvas, ctx: RenderContext) {
    ...
    (node.props.extras["bgDrawable"] as? dev.aetherstudioz.android.support.preview.DrawablePreview)?.let {
...
private fun RenderNode.textPaint(ctx: RenderContext): dev.aetherstudioz.preview.RPaint = ctx.gfx.newPaint().apply {
...
object TextRenderer : Renderer {
    ...
    private fun wrap(node: RenderNode, paint: dev.aetherstudioz.preview.RPaint, maxWidth: Float, ctx: RenderContext): List<CharSequence> {
    ...
    private fun ellipsizeLine(line: CharSequence, paint: dev.aetherstudioz.preview.RPaint, maxWidth: Float, ctx: RenderContext): CharSequence {
