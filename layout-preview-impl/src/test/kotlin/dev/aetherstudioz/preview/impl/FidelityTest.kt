...
import dev.aetherstudioz.android.support.resources.StyleData
import dev.aetherstudioz.preview.GradientType
import dev.aetherstudioz.preview.PreviewEngine
import dev.aetherstudioz.preview.SimpleRenderContext
import dev.aetherstudioz.preview.impl.headless.HeadlessGraphics
import dev.aetherstudioz.preview.impl.headless.RecordingCanvas
...
class FidelityTest {
    ...
    @Test fun `gradient shape background sets a gradient paint`() = withTempDir("preview-grad") { dir ->
        ...
        assertTrue(d is dev.aetherstudioz.android.support.preview.DrawablePreview.Shape)
        val g = (d as dev.aetherstudioz.android.support.preview.DrawablePreview.Shape).spec.gradient
        assertNotNull(g)
        // And the engine maps it to an api Gradient via DrawableBackgroundRenderer (linear here).
        assertEquals(GradientType.LINEAR, dev.aetherstudioz.preview.GradientType.LINEAR)
    }
