import dev.aetherstudioz.build.RelocateTypesInJar
...
// relocate the references onto the shim :lang-jdt ships (dev.aetherstudioz.lang.jdt.compat.RuntimeVersion) and dex the
...
// ship (dev.aetherstudioz.lang.jdt.compat.StackWalker in :lang-jdt) and dex the patched jars. These two modules
