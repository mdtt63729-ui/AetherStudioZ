 ...
 * parameters carries every parameter in its descriptor: adding one field to [dev.aetherstudioz.plugin.PluginManifest]
...
object PluginLoadFailure {
    ...
    private fun mentionsSpi(message: String?): Boolean =
        message != null && ("dev/ide/" in message || "dev.aetherstudioz." in message)
}
