...
import dev.aetherstudioz.platform.impl.MessageBusImpl
 ...
 * becomes a declared, enforced edge. Unload disposes a plugin's tracked [dev.aetherstudioz.platform.Disposable]s (LIFO)
